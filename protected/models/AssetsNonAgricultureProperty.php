...
class AssetsNonAgricultureProperty extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('AssetsId', 'required'),
			array('AssetsId', 'numerical', 'integerOnly'=>true),
			array('Cost, ValueStartOfIncomeYear, ValueChangeDuringIncomeYear', 'numerical'),
			array('Type, Description, CerateAt, LastUpdateAt', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('Id, AssetsId Type, Description, Cost, ValueStartOfIncomeYear, ValueChangeDuringIncomeYear, CerateAt, LastUpdateAt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'Cost' => 'Cost',
			'ValueStartOfIncomeYear' => 'Value Start Of Income Year',
			'ValueChangeDuringIncomeYear' => 'Value Change During Income Year',
			'CerateAt' => 'Cerate At',
	...
	public function search()
	{
		...
		$criteria->compare('ValueStartOfIncomeYear',$this->ValueStartOfIncomeYear);
		$criteria->compare('ValueChangeDuringIncomeYear',$this->ValueChangeDuringIncomeYear);
