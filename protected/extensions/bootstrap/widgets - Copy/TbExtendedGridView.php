...
class TbExtendedGridView extends TbGridView
{
	...
	{
        Bootstrap::getBootstrap()->registerAssetJs('jquery.saveselection.gridview.js');
	...
	public function registerCustomClientScript()
	{
		...
		$fixedHeaderJs = '';
		if ($this->fixedHeader) {
            Bootstrap::getBootstrap()->registerAssetJs('jquery.stickytableheaders' . (!YII_DEBUG ? '.min' : '') . '.js');
		...
		if ($this->sortableRows) {
            ...
            Bootstrap::getBootstrap()->registerAssetJs('jquery.sortable.gridview.js');
		...
		if ($this->selectableCells) {
			...
			$cs->registerCoreScript('jquery.ui');
            Bootstrap::getBootstrap()->registerAssetJs('jquery.selectable.gridview.js');
...
class TbPercentOfTypeEasyPieOperation extends TbPercentOfTypeOperation
{
	...
	protected function registerClientScripts()
	{
        ...
        $bootstrap->registerAssetCss('easy-pie-chart.css');
        $bootstrap->registerAssetJs('jquery.easy.pie.chart.js');
