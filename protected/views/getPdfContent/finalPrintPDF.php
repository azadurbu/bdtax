...
// Yii::import('application.controllers.GetPdfContentController');
...
<?php
    ...
    $totalAssets = (double) GetPdfContentController::Asum_of_particular_field($asset_model, "BusinessCapital", "assets_business_capital") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "ShareholdingCompany", "assets_shareholding_company_list") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "NonAgricultureProperty", "assets_non_agriculture_property") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "AgricultureProperty", "assets_agriculture_property") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "Investment", "assets_investment") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "MotorVehicle", "assets_motor_vehicles") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "Jewelry", "assets_jewelry") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "Furniture", "assets_furniture") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "ElectronicEquipment", "assets_electronic_equipment") +
    // (double) GetPdfContentController::Asum_of_particular_field($asset_model, "OutsideBusiness", "assets_outside_business") +
    (double) GetPdfContentController::Asum_of_particular_field($asset_model, "AnyOtherAssets", "assets_any_other")+
    $cashFundOutsideBusines;
    //$totalAssets = '270000';
    $totalAssets = round($totalAssets, 2);
    
    $totalLiabilities = (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "MortgagesOnProperty", "lia_mortgages_on_property") +
    (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "UnsecuredLoans", "lia_unsecured_loans") +
    (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "BankLoans", "lia_bank_loans") +
    (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "OthersLoan", "lia_others_loan"); 
    ...
    <td style="border: 1px solid #000; padding:5px;" rowspan="2" colspan="2" width="50%" valign="top">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
          ...
          <tr>
            <td>
            <?php
              $tax_year_stripe = str_split(htmlentities(strip_tags($ctaxYear)));
            ?>
...
with disability</td>
   ...
   <tr>
    ...
    <?php
      // $this->taxYear();
      $tax_year = explode('-', htmlentities(strip_tags($ctaxYear)));
...
<table cellspacing="0" cellpadding="0" width="100%" border="1">
	<tbody>
        ...
        <?php echo @$this->totalOutputMain('InterestOnSecurities',$ccpiid,$ctaxYear) +  @$IncomeOtherSourceData->SanchaypatraIncome; ?>
      </td>
		</tr>
		<tr>
			<td width="5%" align="center" style="padding:5px;" valign="top">
		...
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php echo @$this->totalOutputMain('IncomeAgriculture',$ccpiid,$ctaxYear); ?>   
      </td>
		</tr>
		<tr>
			<td width="5%" align="center" style="padding:5px;" valign="top">
        ...
        <?php 
            ...
            echo $$TotalBusinessIncomeCheck = (@$this->totalOutputMain('IncomeBusinessOrProfession',$ccpiid,$ctaxYear) + $Business82CTotal); 
		...
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php echo (@$this->totalOutputMain('IncomeCapitalGains',$ccpiid,$ctaxYear) + @$income_82c->PropertySaleIncome_1); ?>
      </td>
		</tr>
		<tr>
			<td width="5%" align="center" style="padding:5px;" valign="top">
        ...
        <?php 
          ...
          echo (@$this->totalOutputMain('IncomeOtherSource',$ccpiid,$ctaxYear) + $OtherSource82CTotal - @$IncomeOtherSourceData->SanchaypatraIncome); 
        ?>
      </td>
		</tr>
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top"><?php echo @$this->totalOutputMain('IncomeShareProfit',$ccpiid,$ctaxYear); ?></td>
		</tr>
		<tr>
			<td width="5%" align="center" style="padding:5px;" valign="top">
				<p>32</p>
			...
			<td width="23%" style="padding:5px;" valign="top"><?php echo @$this->totalOutputMain('IncomeSpouseOrChild',$ccpiid,$ctaxYear); ?></td>
		</tr>
		<tr>
			<td width="5%" align="center" style="padding:5px;" valign="top">
				<p>33</p>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php 
          echo @$this->totalOutputMain('ForeignIncome',$ccpiid,$ctaxYear);
        ?>
      </td>
		</tr>
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php 
          $totalIncome = $this->totalIncome($ccpiid,$ctaxYear) + @$this->totalOutputMain('ForeignIncome',$ccpiid,$ctaxYear); 
          echo $totalIncome;
        ?>
      </td>
		</tr>
...
<table cellspacing="0" cellpadding="0" width="100%" border="1">
	<tbody>
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php
          $TaxLeviableOnTotalIncome = 0;
          $taxratio = $this->tempPayableTaxRatio($ccpiid,$ctaxYear);
    ...
    ?>
		...
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php
          $minimumTaxValue = $this->minimumTaxValue($ccpiid,$ctaxYear);
     ...
     <?php
      ...
      $surCharge = $this->surCharge($maxValue,$ccpiid,$ctaxYear);
    ?>
		<tr>
			<td width="5%" align="center" style="padding:5px;" valign="top">
				<p>39</p>
        ...
        <?php
          ...
          if($this->getCartax($ccpiid,$ctaxYear)>0 && $this->TaxWithoutCar($ccpiid,$ctaxYear) == 0){
        ...
        <?php
          ...
          if($this->getCartax($ccpiid,$ctaxYear)>$TaxLeviableOnTotalIncome && $gTAPt<0 ){
              $gTAPt = 0;
          }
          echo $gTAPt;
        ?>
		...
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php
          $totalExemptedValue = $this->totalExemptedValue($ccpiid,$ctaxYear);
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
	<tbody>
		<tr>
			<td width="40" style="border: 1px solid #000; padding:5px;" align="center" valign="top">
				<p>49</p>		  </td>
            ...
            <tr>
              ...
              <td style="border-right:1px solid #000; padding:5px;" valign="top"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                  <tr>
                    ...
                    <td style="border:1px solid #000; width:30px; height:25px;"><?php echo ($totalAssets>2500000)?'<img border="0" width="20px" src="'.$tick.'" >':'&nbsp;'; ?></td>
                  </tr>
              </table></td>
	  ...
	  <td width="62%" colspan="3" valign="top" style="border: 1px solid #000; padding:5px;">
			<table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td width="3%" style="padding:5px;" valign="top">&nbsp;</td>
                    <td width="14%" style="border: 1px solid #000;padding:5px;" valign="top">24A</td>
                    ...
                    <td width="3%" style="padding:5px;" valign="top">&nbsp;</td>
                    <td width="14%" style="border: 1px solid #000; padding:5px;" valign="top">24B</td>
                    ...
                    <td width="3%" style="padding:5px;" valign="top">&nbsp;</td>
                    <td width="14%" style="border: 1px solid #000; padding:5px;" valign="top">24C</td>
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top"><?php 
                    echo ($income_model['IncomeBusinessOrProfessionConfirm']=='Yes' && $TotalBusinessIncomeCheck)?'<img border="0" width="20px" src="'.$tick.'" >':'&nbsp;';  ?></td>
                    <td width="3%" style="padding:5px;" valign="top">&nbsp;</td>
                    <td width="14%" style="border: 1px solid #000; padding:5px;" valign="top">24D</td>
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top"><?php 
...
<table cellspacing="0" cellpadding="0" width="100%" border="1">
	<tbody>
		<tr>
			<td rowspan="3" width="45" style="padding:5px;" valign="top">
				<p>55</p>
			</td>
			<td colspan="2" width="94%" style="padding:5px;" valign="top">
        <p>&nbsp;</p>
				<h2><b style="font-weight:bold">Verification</strong></b></h2>
				<h2>I solemnly declare that to the best of my knowledge and belief the information given in this return and statements and documents annexed or attached herewith are correct and complete.</h2>
        <p>&nbsp;</p>
			</td>
		</tr>
		<tr>
			<td width="48%" style="padding:5px;" valign="top">
				<h2>Name</h2><br />
                <h2><?php echo htmlentities(strip_tags(@$personal_info_model->Name)); ?></h2>
                <p>&nbsp;</p>
        ...
        <?php if(isset($signature->signature)){?>
              <img style="height:60px;" src="<?php echo $signature->signature;?>" />
              <p>&nbsp;</p>
        <?php }else{?>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
		...
		<tr>
			<td width="48%" style="padding:5px;" valign="top">
        <p>&nbsp;</p>
				<h3>Date of Signature (DD-MM-YYYY)</h3>
...
<table cellspacing="0" cellpadding="0" width="100%" >
	<tbody>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
			 <h1>Date of Submission(DD-MM-YYYY)</h1>
             <p>&nbsp;</p>
                <table cellspacing="0" cellpadding="0" width="100%" border="0" cellpadding="2" cellspacing="2" style="padding-top:10px;">
                  <tr>
                 
                    <td width="12%" style="border:1px solid #000; padding:1px;height: 50px;"  align="center" valign="top">&nbsp;</td>
                    <td width="12%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top">&nbsp;</td>
                    <td width="2%">&nbsp;</td>
                    <td width="12%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top">&nbsp;</td>
                    <td width="12%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top">&nbsp;</td>
                    <td width="2%">&nbsp;</td>
                    <td width="12%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top"><h2>2</h2></td>
                    <td width="12%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top"><h2>0</h2></td>
                    <td width="12%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top">&nbsp;</td>
                    <td width="12%" style="border:1px solid #000; padding:5pxheight: 50px;;" align="center" valign="top">&nbsp;</td>
                    <td width="2%" style="padding:5px;height: 50px;" valign="top">&nbsp;</td>
                    <td width="2%" style="padding:5px;height: 50px;" valign="top">&nbsp;</td>
                  </tr>
                </table>
                <p>&nbsp;</p>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
				<h1>Tax Office Entry Number</h1>
                <p>&nbsp;</p>
				<table cellspacing="0" cellpadding="0" width="100%" border="0" cellpadding="2" cellspacing="2" style="padding-top:10px;">
				  <tr>
				    <td width="15%" style="border:1px solid #000; padding:5px;height: 50px;"  align="center" valign="top">&nbsp;</td>
                    <td width="1%">&nbsp;</td>
				    <td width="15%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top">&nbsp;</td>
				    <td width="1%">&nbsp;</td>
				    <td width="15%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top">&nbsp;</td>
                    ...
                    <td width="1%">&nbsp;</td>
				    <td width="15%" style="border:1px solid #000; padding:5px;height: 50px;" align="center" valign="top">&nbsp;</td>
                    <td style="height: 50px;" width="1%">&nbsp;</td>
                    <td style="height: 50px;" width="1%">&nbsp;</td>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
	<tbody>
		<tr>
			<td rowspan="2" width="50%" style="padding:10px;border:1px solid #000;" valign="top">
		    <h2>Assessment Year</h2>
		    <table cellspacing="0" cellpadding="0" width="100%">
		      <tr>
		        <td width="45" style="border:1px solid #000; padding:5px;" valign="top"><h2>2</h2></td>
		        <td width="45" style="border:1px solid #000; padding:5px;" valign="top"><h2>0</h2></td>
		        <td width="45" style="border:1px solid #000; padding:5px;" valign="top"><h2><?php echo $tax_year_stripe[2];?></h2></td>
		        <td width="45" style="border:1px solid #000; padding:5px;" valign="top"><h2><?php echo $tax_year_stripe[3];?></h2></td>
		        <td align="center" width="45" style="padding:5px;" valign="top"><h2>-</h2></td>
		        <td width="45" style="border:1px solid #000; padding:5px;" valign="top"><h2><?php echo $tax_year_stripe[7];?></h2></td>
		        <td width="45" style="border:1px solid #000; padding:5px;" valign="top"><h2><?php echo $tax_year_stripe[8];?></h2></td>
	          </tr>
		      </table>
		   </td>
			<td colspan="2" width="49%" style="border:1px solid #000;text-align:center;" valign="top">
				<h2>Return under section 82BB? (tick one)</h2>
			</td>
		</tr>
		<tr>
			<td width="23%" style="border:1px solid #000; padding:5px 0 5px 5px; " valign="top">
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td width="50" valign="top" style="padding:0px;"><h2>Yes</h2></td>
                    <td width="10" valign="top">&nbsp;</td>
                    <td width="30" style="border:1px solid #000; height:25px; text-align:center;padding-right: 3px;" valign="top"><?php echo ($data82bb_info->checked==1 && isset($data82bb_info))?'<img border="0" style="margin-right:3px;" width="20px" src="'.$tick.'" >':'&nbsp;'; ?></td>
                    <td width="10" valign="top">&nbsp;</td>
                  </tr>
                </table>
			...
			<td width="23%" style="border:1px solid #000; padding:5px 0 5px 5px;" valign="top">
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td width="50" valign="top" style="padding-top:0px;"><h2>No</h2></td>
                    <td width="10" valign="top">&nbsp;</td>
                    <td width="30" style="border:1px solid #000; height:25px; text-align:center;padding: 3px;" valign="top"><?php echo ($data82bb_info->checked != 1 || !isset($data82bb_info))?'<img border="0"  width="20px" src="'.$tick.'" >':'&nbsp;'; ?></td>
                    <td width="10" valign="top">&nbsp;</td>
                  </tr>
                </table>
		...
		<tr>
			<td colspan="3" width="100%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Name of the Assessee</h2>
        <p>&nbsp;</p>
				<h2><?php echo htmlentities(strip_tags(@$personal_info_model->Name)); ?></h2>
			</td>
		</tr>
		<tr>
			<td width="50%"  style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Twelve-digit TIN</h2>
        <p>&nbsp;</p>
        <h2><?php echo htmlentities(strip_tags(@$this->_decode($personal_info_model->ETIN))); ?></h2>
			</td>
			<td colspan="2" width="49%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Old TIN</h2>
                <h3>&nbsp;</h3>
			</td>
		</tr>
		<tr>
			<td width="50%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Circle</h2>
        <p>&nbsp;</p>
        <h2><?php echo htmlentities(strip_tags(@$personal_info_model->TaxesCircle))?></h2>
      </td>
      <td colspan="2" width="49%" style="border:1px solid #000; padding:10px;" valign="top">
        <h2 style="margin-bottom: 7px;">Taxes Zone</h2>
        <p>&nbsp;</p>
        <h2><?php echo htmlentities(strip_tags(@$personal_info_model->TaxesZone))?></h2>
			</td>
		</tr>
		<tr>
			<td colspan="3" width="100%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Total income shown (serial 34)</h2>
        <p>&nbsp;</p>
				<h2>Tk 
          <?php 
            echo $totalIncome;
		...
		<tr>
			<td width="50%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Amount payable (serial 41)</h2>
        <p>&nbsp;</p>
				<h2>Tk 
          <?php
            $GrandTotalPayableTax += $surCharge['surchargeAmount'];
          ...
          ?>
			...
			<td colspan="2" width="49%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Amount paid and adjusted (serial 46)</h2>
        <p>&nbsp;</p>
				<h2 >Tk 
          <?php 
            // echo ($totalAdjustment > 0) ? $totalAdjustment : '';
		...
		<tr>
			<td width="50%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Amount of net wealth shown in IT10B2016</h2>
        <p>&nbsp;</p>
				<h2>Tk <?php echo ($totalAssets - $totalLiabilities);?></h2>
			</td>
			<td colspan="2" width="49%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2 style="margin-bottom: 7px;">Amount of net wealth surcharge paid</h2>
        <p>&nbsp;</p>
				<h2>Tk 
          <?php
            $GrandTotalPayableTax = round( ($TaxLeviableOnTotalIncome - $ActualRebateAmount) );
            $surCharge = $this->surCharge($GrandTotalPayableTax,$ccpiid,$ctaxYear);
            echo $surCharge['surchargeAmount'];
          ?>
        </h2>
              <h3>&nbsp;</h3>
		...
		<tr>
			<td width="50%" style="border:1px solid #000; padding:10px;" valign="top">
        <p>&nbsp;</p>
				<h2 style="margin-bottom: 3px;">Date of Submission(DD-MM-YYYY)</h2>
                <table cellspacing="0" cellpadding="0" width="100%" border="0" cellpadding="2" cellspacing="2" style="padding-top:10px;">
                  <tr>
                    ...
                    <td width="12%" style="border:1px solid #000; padding:5px;" align="center" valign="top">&nbsp;</td>
                    <td width="2%">&nbsp;</td>
                    <td width="12%" style="border:1px solid #000; padding:5px;" align="center" valign="top"><h2>2</h2></td>
                    <td width="12%" style="border:1px solid #000; padding:5px;" align="center" valign="top"><h2>0</h2></td>
                    <td width="12%" style="border:1px solid #000; padding:5px;" align="center" valign="top">&nbsp;</td>
                    <td width="12%" style="border:1px solid #000; padding:5px;" align="center" valign="top">&nbsp;</td>
                    <td width="2%" style="padding:5px;" valign="top">&nbsp;</td>
                    <td width="2%" style="padding:5px;" valign="top">&nbsp;</td>
			...
			<td colspan="2" width="49%" style="border:1px solid #000; padding:10px;" valign="top">
        <p>&nbsp;</p>
				<h2 style="margin-bottom: 7px;">Tax Office Entry Number</h2>
                <h3>&nbsp;</h3>
                <p>&nbsp;</p>
			</td>
		</tr> 
		<tr>
			<td colspan="3" width="100%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2>Signature and seal of the official receiving the return</h2>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
		...
		<tr>
			<td width="50%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2>Date of Signature</h2>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
			</td>
			<td colspan="2" width="49%" style="border:1px solid #000; padding:10px;" valign="top">
				<h2>Contact Number of Tax Office</h2>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
			</td>
...
<p style="text-align:center; font-weight:normal; font-size:12px; padding:0px;">Particulars of income from house property</p>
<p style="text-align:center; font-weight:normal; font-size:12px; padding:0px;"><em>Annex this Schedule to the return of income if you have income from house property</em></p>
<br/>
...
<table width="100%"  cellspacing="0" style="margin-top:40px;" cellpadding="0" width="100%" border="1">
  <tbody>
    <tr>
      <td width="42" style="padding:5px;" valign="top">
        <p>03</p>
...
<p style="font-weight:normal;margin-bottom:0px;padding:0px;margin-top:50px;">Use serial numbers if more names and addresses</p>
<table width="100%" style="margin-top:10px;" cellpadding="0" border="1">
  <tbody>
    <tr>
...
<table width="100%" cellspacing="0" style="margin-top:50px" cellpadding="0" width="100%" border="1">
  <tbody>
    <tr>
      <td colspan="2" width="456" style="padding:3px;" valign="top">
...
<table width="100%" cellpadding="0" border="1" style="margin-top:50px">
  <tbody>
    <tr>
      <td width="306" style="padding:2px;" valign="top">
        <p>Name&nbsp;</p>
        <p><?php echo htmlentities(strip_tags(@$personal_info_model->Name)); ?></p>
        <p>&nbsp;</p>                   
      </td>
      <td width="312" style="padding:2px;" valign="top">
        <p>Signature &amp; Date</p>
          <?php if(isset($signature->signature)){?>
  ...
  <table width="100%" cellpadding="0" border="1">
    <tbody>
      <tr>
        ...
        <td colspan="3" width="576" style="padding:3px;" valign="top">
          <p>Type of main business or profession&nbsp;</p>
          <p>&nbsp;</p>
        </td>
      </tr>
...
<table cellspacing="0" cellpadding="0" width="646">
    ...
    <?php 
      $fixedCore=10000000;
      //$fixedCore=15000000;
      $percentageOfTotalIncome = ($totalIncome - @$this->totalOutputMain('ForeignIncome',$ccpiid,$ctaxYear) - @$IncomeOtherSourceData->SanchaypatraIncome) *.25;
...
<table cellspacing="0" cellpadding="0" width="648" border="1">
	<tbody>
		<tr>
			...
			<td width="342" style="padding:2px;" valign="top">
				<p>Signature &amp; Date</p>
				<?php if(isset($signature->signature)){?>
              <img style="height:60px" src="<?php echo $signature->signature;?>" />
           <?php }else{?>
...
<table cellspacing="0" cellpadding="0" width="101%" border="1">
	...
	<tbody>
      ...
      <td width="21%" style="padding:5px;" valign="top">
				<p><?php echo ((double)(GetPdfContentController::Asum_of_particular_field($asset_model, "BusinessCapital", "assets_business_capital"))+(double)(GetPdfContentController::Asum_of_particular_field($asset_model, "ShareholdingCompany", "assets_shareholding_company_list"))) ?></p>
      </td>
    </tr>
    <tr>
      ...
      <td width="21%" style="padding:5px;" valign="top">
        <p><?php echo (GetPdfContentController::Asum_of_particular_field($asset_model, "BusinessCapital", "assets_business_capital") > 0) ? GetPdfContentController::Asum_of_particular_field($asset_model, "BusinessCapital", "assets_business_capital") : ''; ?></p>
			</td>
		</tr>
		<tr>
			<td width="6%" style="padding:5px;" valign="top">
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php echo (GetPdfContentController::Asum_of_particular_field($asset_model, "ShareholdingCompany", "assets_shareholding_company_list") > 0) ? GetPdfContentController::Asum_of_particular_field($asset_model, "ShareholdingCompany", "assets_shareholding_company_list") : ''; ?></p>
			</td>
		</tr>
    <?php
    ...
    ?>
		<tr>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p>
          <?php echo $noagroval =  (GetPdfContentController::Asum_of_particular_field($asset_model, "NonAgricultureProperty", "assets_non_agriculture_property") > 0) ? GetPdfContentController::Asum_of_particular_field($asset_model, "NonAgricultureProperty", "assets_non_agriculture_property") : ''; ?>
          <?php 
          if($noagroval==''){
             echo number_format($nonAgro,2);
          } ?>
        </p>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p>
          <?php echo (GetPdfContentController::Asum_of_particular_field($asset_model, "AgricultureProperty", "assets_agriculture_property") > 0) ? GetPdfContentController::Asum_of_particular_field($asset_model, "AgricultureProperty", "assets_agriculture_property") : ''; ?>
        </p>
			</td>
		</tr>
    <?php
      ...
      $totalFinancial = $shares+$bond + $prizeBond + $loan + $other;
    ?>
		<tr>
        ...
        ?>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php echo (@$asset_model->InvestmentFOrT == 'Fraction') ? $this->sum_of_investment(@$asset_model->AssetsId, 'Other Investment', 'assets_investment') : @$asset_model->InvestOtherTotal; ?></p>
			</td>
		</tr>
		<tr>
    ...
    <tr>
      ...
      <td width="21%" style="padding:5px;" valign="top">
		...
		<tr>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php
        $bank_borrowing = (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "MortgagesOnProperty", "lia_mortgages_on_property") + (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "BankLoans", "lia_bank_loans");
        echo $bank_borrowing;      
        ?></p>
			</td>
		</tr>
		<tr>
          ...
          ?>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php echo (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "UnsecuredLoans", "lia_unsecured_loans"); ?></p>
			</td>
		</tr>
		<tr>
			<td width="6%" style="padding:5px;" valign="top">
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php echo (double) GetPdfContentController::Lsum_of_particular_field($liability_model, "OthersLoan", "lia_others_loan"); ?></p>
			</td>
		</tr>
		<tr>
			<td width="5%" style="padding:5px;" valign="top">
    ...
    <?php
      ...
      $totalExpence = (double) GetPdfContentController::Esum_of_particular_field($expence_model, "PersonalFooding", "exp_personal_fooding") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "Accommodation", "exp_accommodation") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "Transport", "exp_transport") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "OtherTransport", "exp_other_transport") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "ElectricityBill", "exp_electricity_bill") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "WasaBill", "exp_wasa_bill") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "GasBill", "exp_gas_bill") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "TelephoneBill", "exp_telephone_bill") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "OtherHousehold", "exp_other_household") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "ChildrenEducation", "exp_children_education") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "FestivalOtherSpecial", "exp_festival_other_special") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "PersonalForeignTravel", "exp_personal_foreign_travel") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "Donation", "exp_donation") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "OtherSpecial", "exp_other_special") +
      (double) GetPdfContentController::Esum_of_particular_field($expence_model, "Other", "exp_other");
      //$totalExpence = 50000;
      ...
      $totalTaxCharges = GetPdfContentController::Esum_of_particular_field($expence_model, "TaxAtSource", "exp_tax_at_source") + GetPdfContentController::Esum_of_particular_field($expence_model, "SurchargeOther", "exp_surcharge_other");
      //$totalTaxCharges = 3000;
    ...
    <?php 
       ...
       //$total_other_fund_outflow=2000;
      $total_other_fund_outflow = $totalExpenseAndTax + (double) GetPdfContentController::Esum_of_particular_field($expence_model, "LossDeductions", "exp_loss_deductions")+ (double) GetPdfContentController::Esum_of_particular_field($expence_model, "GiftDonationContribution", "exp_gift_donation_contribution");
    ?>
		<tr>
			<td rowspan="4" width="5%" style="padding:5px;" valign="top">
				<p>19</p>
		...
		<tr>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php echo (double) GetPdfContentController::Esum_of_particular_field($expence_model, "LossDeductions", "exp_loss_deductions");?></p>
			</td>
		</tr>
		<tr>
			<td width="6%" style="padding:5px;" valign="top">
        ...
        <p><?php echo $expence_model->GiftDonationContributionComment; ?></p>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php echo (double) GetPdfContentController::Esum_of_particular_field($expence_model, "GiftDonationContribution", "exp_gift_donation_contribution");?></p>
			</td>
		</tr>
...
<table cellspacing="0" cellpadding="0" width="101%" border="1">
	<tbody>
		<tr>
			...
			<td width="42%" style="padding:5px;" valign="top">
				<p>Assessment Year</p>
				<p><?php echo htmlentities(strip_tags($ctaxYear));?></p>
				<p>&nbsp;</p>
			</td>
			<td width="6%" style="padding:5px;" valign="top">
				<p>02</p>
...
<table cellspacing="0" cellpadding="0" width="100%" border="1">
	...
	<tbody>
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "PersonalFooding", "exp_personal_fooding") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "PersonalFooding", "exp_personal_fooding") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "Accommodation", "exp_accommodation") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "Accommodation", "exp_accommodation") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
    ...
    <?php 
      $totalTransportation = GetPdfContentController::Esum_of_particular_field($expence_model, "Transport", "exp_transport") + GetPdfContentController::Esum_of_particular_field($expence_model, "OtherTransport", "exp_other_transport");
    ?>
		<tr>
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "Transport", "exp_transport") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "Transport", "exp_transport") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "OtherTransport", "exp_other_transport") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "OtherTransport", "exp_other_transport") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
    ...
    <?php 
      $totalHousehold = GetPdfContentController::Esum_of_particular_field($expence_model, "ElectricityBill", "exp_electricity_bill") + GetPdfContentController::Esum_of_particular_field($expence_model, "GasBill", "exp_gas_bill") + GetPdfContentController::Esum_of_particular_field($expence_model, "WasaBill", "exp_wasa_bill") + GetPdfContentController::Esum_of_particular_field($expence_model, "TelephoneBill", "exp_telephone_bill") + GetPdfContentController::Esum_of_particular_field($expence_model, "OtherHousehold", "exp_other_household");
    ?>
		<tr>
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "ElectricityBill", "exp_electricity_bill") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "ElectricityBill", "exp_electricity_bill") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
        <?php
          $gas = (GetPdfContentController::Esum_of_particular_field($expence_model, "GasBill", "exp_gas_bill") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "GasBill", "exp_gas_bill") : '';
          $wasa = (GetPdfContentController::Esum_of_particular_field($expence_model, "WasaBill", "exp_wasa_bill") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "WasaBill", "exp_wasa_bill") : '';
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "TelephoneBill", "exp_telephone_bill") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "TelephoneBill", "exp_telephone_bill") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top"> 
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "OtherHousehold", "exp_other_household") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "OtherHousehold", "exp_other_household") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "ChildrenEducation", "exp_children_education") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "ChildrenEducation", "exp_children_education") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
    ...
    <?php 
      $totalSpecialExpense = GetPdfContentController::Esum_of_particular_field($expence_model, "FestivalOtherSpecial", "exp_festival_other_special") + GetPdfContentController::Esum_of_particular_field($expence_model, "PersonalForeignTravel", "exp_personal_foreign_travel") + GetPdfContentController::Esum_of_particular_field($expence_model, "Donation", "exp_donation") + GetPdfContentController::Esum_of_particular_field($expence_model, "OtherSpecial", "exp_other_special");
    ?>
		<tr>
			<td rowspan="5" width="6%" style="padding:0 5px 7px 5px;text-align:center" valign="top">
				<p>10</p>
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "FestivalOtherSpecial", "exp_festival_other_special") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "FestivalOtherSpecial", "exp_festival_other_special") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "PersonalForeignTravel", "exp_personal_foreign_travel") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "PersonalForeignTravel", "exp_personal_foreign_travel") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "Donation", "exp_donation") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "Donation", "exp_donation") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "OtherSpecial", "exp_other_special") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "OtherSpecial", "exp_other_special") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "Other", "exp_other") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "Other", "exp_other") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
    ...
    ?>
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "TaxAtSource", "exp_tax_at_source") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "TaxAtSource", "exp_tax_at_source") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
		...
		<tr>
			...
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
				<p><?php echo (GetPdfContentController::Esum_of_particular_field($expence_model, "SurchargeOther", "exp_surcharge_other") > 0) ? GetPdfContentController::Esum_of_particular_field($expence_model, "SurchargeOther", "exp_surcharge_other") : ''; ?></p>
			</td>
			<td width="22%" style="padding:0 5px 7px 5px;" valign="top">
