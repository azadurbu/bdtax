...
/**
 * This is the model class for table "exp_other_household".
 *
 * The followings are the available columns in table 'exp_other_household':
 * @property integer $Id
 ...
 */
class ExpOtherHousehold extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpGasBill the static model class
	 */
