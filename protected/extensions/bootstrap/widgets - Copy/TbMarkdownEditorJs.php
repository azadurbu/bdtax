...
class TbMarkdownEditorJS extends CInputWidget
{
	...
	public function registerClientScript($id)
	{
        ...
        $bootstrap->registerAssetCss('markdown.editor.css');
        $bootstrap->registerAssetJs('markdown.converter.js', CClientScript::POS_HEAD);
        $bootstrap->registerAssetJs('markdown.sanitizer.js', CClientScript::POS_HEAD);
        $bootstrap->registerAssetJs('markdown.editor.js', CClientScript::POS_HEAD);
