...
class AssetsMotorVehicles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('MVDescription, CerateAt, LastUpdateAt', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('Id, AssetsId, MotorVehicleType, RegistrationNo, MVDescription, MVValue, CerateAt, LastUpdateAt', 'safe', 'on'=>'search'),
		);
	}
