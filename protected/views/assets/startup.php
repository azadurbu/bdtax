<div id="home-mid" class="reg-form income-dashbord">
	...
	<p><?php //echo Yii::t("assets","<p>Demo Text (Information is not given)</p>")?></p>

	<!-- <h2><a href="<?=Yii::app()->baseUrl.'/index.php/assets/entry'?>"><?=Yii::t("common", "Let's get started")?></a></h2> -->

	<?php 
	$haveLastYearDatas = Assets::model()->count('CPIId=:data AND EntryYear=:data2',array(':data'=>Yii::app()->user->CPIId, ':data2'=>$last_tax_year ));
	...
	<br><br><br><br><br>
	<?php }else{?>
	<h2><a href="<?=Yii::app()->baseUrl.'/index.php/assets/entry'?>"><?=Yii::t("expense","Let's get started")?></a></h2>
	<?php } ?>
<!-- Modal -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="pull-right" style="margin-right: 10px;">
				<a href='<?=Yii::app()->baseUrl.'/index.php/assets/entry'?>' class='btn btn-success for-clr'><?=Yii::t("assets","Yes")?></a>
			</div>
			<br>
        </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="pull-right" style="margin-right: 10px;">
				<a href='<?=Yii::app()->baseUrl.'/index.php/assets/copyLastyear'?>' class='btn btn-success for-clr'><?=Yii::t("assets","Yes")?></a>
			</div>
			<br>
        </div>
        <div class="modal-footer">
