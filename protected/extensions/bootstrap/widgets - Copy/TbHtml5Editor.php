...
class TbHtml5Editor extends CInputWidget
{
	...
	public function registerClientScript($id)
	{
        ...
        $bootstrap->registerAssetCss('bootstrap-wysihtml5.css');
        $bootstrap->registerAssetJs('wysihtml5-0.3.0.js');
        $bootstrap->registerAssetJs('bootstrap-wysihtml5.js');

		if (isset($this->editorOptions['locale'])) {
            $bootstrap->registerAssetJs(
            ...
            $bootstrap->registerAssetJs('locales/bootstrap-wysihtml5.' . $this->lang . '.js');
	...
	private function insertDefaultStylesheetIfColorsEnabled()
	{
		...
		$defaultStyleSheetUrl = Bootstrap::getBootstrap()->getAssetsUrl() . '/css/wysiwyg-color.css';
