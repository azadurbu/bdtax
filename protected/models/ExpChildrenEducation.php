...
/**
 * This is the model class for table "exp_children_education".
 *
 * The followings are the available columns in table 'exp_children_education':
 * @property integer $Id
 ...
 */
class ExpChildrenEducation extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpChildrenEducation the static model class
	 */
