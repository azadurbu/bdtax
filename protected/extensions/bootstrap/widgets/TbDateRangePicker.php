...
class TbDateRangePicker extends TbBaseInputWidget
{
	...
	{
		if ($this->selector) {
            Bootstrap::getBootstrap()->registerDateRangePlugin($this->selector, $this->options, $this->callback);
		} else {
            ...
            Bootstrap::getBootstrap()->registerDateRangePlugin('#' . $id, $this->options, $this->callback);
		}
	...
	public function registerClientScript()
	{
        ...
        $bootstrap->registerAssetCss('bootstrap-daterangepicker.css');
        $bootstrap->registerAssetJs('bootstrap.daterangepicker.js');
