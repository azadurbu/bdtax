<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'inc-income-agriculture-form',
...
<div class="form-group"><?php echo CHtml::activeLabelEx($model,'LandInBigha'); ?>
<div class="col-sm-5 col-sm-9 form-inline"><?php echo $form->textArea($model,'LandInBigha',array('rows'=>6, 'cols'=>50)); ?>
<?php echo $form->error($model,'LandInBigha'); ?>

</div></div>

<div class="form-group"><?php echo CHtml::activeLabelEx($model,'CorpseType'); ?>
<div class="col-sm-5 col-sm-9 form-inline"><?php echo $form->textArea($model,'CorpseType',array('rows'=>6, 'cols'=>50)); ?>
<?php echo $form->error($model,'CorpseType'); ?>

</div></div>

<div class="form-group"><?php echo CHtml::activeLabelEx($model,'TotalRevenue'); ?>
<div class="col-sm-5 col-sm-9 form-inline"><?php echo $form->textField($model,'TotalRevenue'); ?>
<?php echo $form->error($model,'TotalRevenue'); ?>

</div></div>

<div class="form-group"><?php echo CHtml::activeLabelEx($model,'ProductionCost'); ?>
<div class="col-sm-5 col-sm-9 form-inline"><?php echo $form->textField($model,'ProductionCost'); ?>
<?php echo $form->error($model,'ProductionCost'); ?>
