...
/**
 * This is the model class for table "lia_others_loan".
 *
 * The followings are the available columns in table 'lia_others_loan':
 * @property integer $Id
 ...
 */
class LiaOthersLoan extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LiaOthersLoan the static model class
	 */
