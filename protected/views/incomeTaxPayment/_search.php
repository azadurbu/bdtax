<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldRow($model,'DeductedAtSource',array('class'=>'span5')); ?>

		<?php echo $form->textFieldRow($model,'AdvanceTax',array('class'=>'span5')); ?>

		<?php echo $form->textFieldRow($model,'TaxPaidOnReturn',array('class'=>'span5')); ?>

		<?php echo $form->textFieldRow($model,'AdjustmentTaxRefund',array('class'=>'span5')); ?>
