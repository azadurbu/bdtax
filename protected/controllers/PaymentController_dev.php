	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
			    'actions' => array('index', 'success', 'fail', 'cancel','LoadPaymentData','LoadUpgradePaymentData'),
				'users' => array('@'),
			...
			if ($payment == null) {
                ...
                /* New Code */
				 $currentPlanId =  $this->userCurrentPlan()->plan_id;
					...
					if($plan_id==1 &&($currentPlanId==3 || $currentPlanId==6|| $currentPlanId==7)){
                        if($currentPlanId==3){
                        	$newplanId = 1;
	...
	function actionLoadPaymentData(){
		...
		$post_data['total_amount'] = $serviceCharge-$amount;
			...
			//round($serviceCharge - $amount);
				...
				$sslc = new SSLCommerz();
				$options = $sslc->initiate($post_data, true);
				$Innerhtml = $this->renderPartial('load_ssl_options', array('options'=>$options),true);
