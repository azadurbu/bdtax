                                    ...
                                    <tbody id="mytable">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <i class="fa fa-question-circle fa-1" /*data-toggle="tooltip" */ title="<?=Yii::t('TTips', "")?>"></i>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <br/>
                                                <p class="contribution-income" style="color:red;font-size: 12px;float:left;display: none;">Please enter your contribution provident fund amount to both Tax Rebate and Cash Asset page.</p>
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->EmployersContributionProvidentFund ?>" type="text" autocomplete="off" onclick="showwarning('contribution-income')" onkeyup="onValuePut(this)" onblur="hidewarning('contribution-income')" class="form-control" id="IncomeSalaries_EmployersContributionProvidentFund_1" name="IncomeSalaries_EmployersContributionProvidentFund_1">
                                            </td>
                                            <td>
