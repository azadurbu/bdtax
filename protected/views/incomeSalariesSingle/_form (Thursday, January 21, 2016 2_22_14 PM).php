						...
						<div class="panel panel-success">
								...
								<div class="table-responsive">
									<table  class="table table-bordred table-striped">
										...
										<thead>
											<th><?=Yii::t('income',"Pay & Allowance")?></th>
											<th><?=Yii::t('income',"Amount of Income")?></th>
											<th><?=Yii::t('income',"Amount of exempted income")?></th>
...
&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"6.1")?>"></i>
												...
												<td><input value="<?php echo @$model->BasicPay ?>" type="text" autocomplete="off" onkeyup="onValuePut(this), onHouseRentTaxCal(this),onMedicalWaiverTaxCal()" class="form-control" id="IncomeSalaries_BasicPay_1" name="IncomeSalaries_BasicPay_1"></td>
...
&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"6.4")?>"></i>
												...
												<td><input value="<?php echo @$model->ConveyanceAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onConveyTaxCal(this)" class="form-control" id="IncomeSalaries_ConveyanceAllowance_1" name="IncomeSalaries[ConveyanceAllowance_1]"></td>
...
&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"6.5")?>"></i>
												...
												<td><input value="<?php echo @$model->HouseRentAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onHouseRentTaxCal(this)" class="form-control" id="IncomeSalaries_HouseRentAllowance_1" name="IncomeSalaries[HouseRentAllowance_1]"></td>
...
&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"6.6")?>"></i>
												...
												<td><input value="<?php echo @$model->MedicalAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onMedicalWaiverTaxCal(this)" class="form-control" id="IncomeSalaries_MedicalAllowance_1" name="IncomeSalaries[MedicalAllowance_1]"></td>
