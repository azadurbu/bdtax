...
$this->breadcrumbs=array(
	Yii::t('user','Family')=>array('/user/family'),
	Yii::t('user','User'),
);

$this->menu=array(
    array('label'=>Yii::t('user','Create Family Members'), 'url'=>array('create')),
    array('label'=>Yii::t('user','Manage Family Members'), 'url'=>array('family/admin')),
);
...
//echo $test->company;?>
											...
											<tr>
                                                ...
                                                <td class="toolbar">
													<div class="btn-group">
														...
														<a href="<?php echo yii::app()->request->baseUrl;?>/index.php/user/family/update_family/id/<?php echo $data->id;?>"><button class="btn"><span class="icon-edit"></span></button></a>
														<a href="<?php echo yii::app()->request->baseUrl;?>/index.php/user/family/delete/id/<?php echo $data->id;?>"><button class="btn"><span class="icon-trash"></span></button></a>
													</div>
												</td>
    ...
    <div class="data-container">
        ...
        <div class="span3 "><a href="<?php echo yii::app()->request->baseUrl;?>/index.php/user/family/create">Add Family Member</a></div>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		array(
			'name' => 'id',
			'type'=>'raw',
			'value' => 'CHtml::link(CHtml::encode($data->id),array("family/update","id"=>$data->id))',
		),
		array(
			'name' => 'company',
			'type'=>'raw',
			'value' => 'CHtml::link(UHtml::markSearch($data,"company"),array("family/view","id"=>$data->id))',
		),
		array(
			'name'=>'email',
			'type'=>'raw',
