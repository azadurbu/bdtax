...
/**
 * This is the model class for table "exp_personal_foreign_travel".
 *
 * The followings are the available columns in table 'exp_personal_foreign_travel':
 * @property integer $Id
 ...
 */
class ExpPersonalForeignTravel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpPersonalForeignTravel the static model class
	 */
	...
	{
		return 'exp_personal_foreign_travel';
	}
