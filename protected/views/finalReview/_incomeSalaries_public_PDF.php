<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tbody>
		...
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->SpecialPay_1; ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->SpecialPay_1; ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->DearnessAllowance_1 ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->DearnessAllowance_1 ?></td>
      		<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
    </tr>
		<tr>
		...
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->EntertainmentAllowance_1 ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->EntertainmentAllowance_1 ?></td>
		</tr>
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->ServantAllowance_1 ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->ServantAllowance_1 ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->OvertimeAllowance_1 ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->OvertimeAllowance_1 ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo number_format((double)(@$income_salaries_model->Bonus + @$income_salaries_model->FestivalBonus_1 + @$income_salaries_model->BengaliNewYearBonus_1),2,'.','') ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo (@$income_salaries_model->BengaliNewYearBonus_1) ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo number_format((double)(@$income_salaries_model->Bonus + @$income_salaries_model->FestivalBonus_1),2,'.','') ?></td>
		</tr>
		<tr>
			<td width="5%" style="padding:5px 10px;">
				<p>17</p>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->OtherAllowances_1 ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->OtherAllowances_1 ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->EmployersContributionProvidentFund_1 ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->EmployersContributionProvidentFund_1 ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->DeemedIncomeTransport_1 ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->DeemedIncomeTransport_1 ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->DeemedFreeAccommodation_1 ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo @$income_salaries_model->DeemedFreeAccommodation_1 ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
			...
			<td width="18%" style="padding:5px 10px;"><?php echo (@$income_salaries_model->Others_1) ?></td>
			<td width="18%" style="padding:5px 10px;"><?php echo (@$income_salaries_model->Others_1) ?></td>
			<td width="18%" style="padding:5px 10px;">0&nbsp;</td>
		</tr>
		<tr>
