...
/**
 * This is the model class for table "exp_other_special".
 *
 * The followings are the available columns in table 'exp_other_special':
 * @property integer $Id
 ...
 */
class ExpOtherSpecial extends CActiveRecord
{
	/**
