 ...
 */
class TbToggleColumnOrg extends TbDataColumn
{
	...
	protected function initButton()
	{
		if ($this->checkedButtonLabel === null) {
			$this->checkedButtonLabel = Yii::t('zii', 'Active');
		}
		if ($this->uncheckedButtonLabel === null) {
			$this->uncheckedButtonLabel = Yii::t('zii', 'Inactive');
		}
        ...
        $this->button = array(
            'url' =>  'Yii::app()->controller->createUrl("' . $this->toggleAction . '/id/$data->primaryKey/attribute/' . $this->name . '",array())',
