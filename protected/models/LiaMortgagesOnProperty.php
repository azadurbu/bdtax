...
/**
 * This is the model class for table "lia_mortgages_on_property".
 *
 * The followings are the available columns in table 'lia_mortgages_on_property':
 * @property integer $Id
 ...
 */
class LiaMortgagesOnProperty extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LiaMortgagesOnProperty the static model class
	 */
	...
	{
		return 'lia_mortgages_on_property';
	}
