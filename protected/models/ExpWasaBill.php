...
/**
 * This is the model class for table "exp_wasa_bill".
 *
 * The followings are the available columns in table 'exp_wasa_bill':
 * @property integer $Id
 ...
 */
class ExpWasaBill extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpWasaBill the static model class
	 */
