...
/**
 * This is the model class for table "inc_foreign_income".
 *
 * The followings are the available columns in table 'inc_foreign_income':
 * @property integer $ForeignIncomeId
 ...
 */
class IncForeignIncome extends CActiveRecord
{
	public $SumOfForeignIncome;

	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return IncForeignIncome the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('ForeignIncomeId, IncomeId, Type, Description, Cost, CerateAt, LastUpdateAt, CPIId, EntryYear, trash', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'ForeignIncomeId' => 'Foreign Income',
			'IncomeId' => 'Income',
			'Type' => 'Type',
	...
	public function search()
	{
		...
		$criteria->compare('ForeignIncomeId',$this->ForeignIncomeId);
