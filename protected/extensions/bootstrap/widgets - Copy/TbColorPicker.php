...
class TbColorPicker extends TbBaseInputWidget
{
	...
	{
        Bootstrap::getBootstrap()->registerAssetJs('bootstrap.colorpicker.js', CClientScript::POS_HEAD);
        Bootstrap::getBootstrap()->registerAssetCss('bootstrap-colorpicker.css');
