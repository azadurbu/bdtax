...
<table width="100%" cellspacing="0" cellpadding="0" border="1">
		...
		<tr border="1">
			<td valign="top" align="center" >
				<table  style="border:1px #000 solid; padding:0px 0px 0px 0px;" width="100%" cellspacing="0" cellpadding="br6">
					<tbody><tr>
						<td valign="middle" align="left">1. Name of the Assessee: <u><?php echo htmlentities(strip_tags(@$personal_info_model->Name)); ?></u></td>
					</tr>
					<tr>
				...
				<?php $etin = str_split(htmlentities(strip_tags(@$personal_info_model->ETIN)));?>
				<tr>
					<td valign="middle" align="left"><table width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							<tr>
	...
	<tr>
		<td valign="middle" align="left">
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tbody><tr>
					<td width="45%">5. (a) Circle: <u><?php echo htmlentities(strip_tags(@$personal_info_model->TaxesCircle)); ?></u></td>
					<td width="45%">   (b) Taxes Zone: <u><?php echo htmlentities(strip_tags(@$personal_info_model->TaxesZone)); ?></u></td>
				</tr>
				<tr>
	...
	<tr>
		<td valign="middle" align="left">9. Name of the employer/business (where applicable): <u><?php echo htmlentities(strip_tags(@$personal_info_model->EmployerName)) ?></u></td>
	</tr>
	<tr>
		<td valign="middle" align="left">10. Wife/Husbands Name (if assessee, please mention TIN): <u><?php echo htmlentities(strip_tags(@$personal_info_model->SpouseName)) ?>, <?php echo @$personal_info_model->SpouseETIN ?></u></td>
	</tr>
	<tr>
		<td valign="middle" align="left">11. Fathers Name: <u><?php echo htmlentities(strip_tags(@$personal_info_model->FathersName)) ?></u></td>
	</tr>
	<tr>
		<td valign="middle" align="left">12. Mothers Name: <u><?php echo htmlentities(strip_tags(@$personal_info_model->MothersName)) ?></u></td>
	</tr>
	<tr>
		<td valign="middle" align="left">
			<?php
  	...
  	<td valign="top" align="center">
  		<table cellspacing="0" cellpadding="0" border="1" style="font-family:'Times New Roman';">
  			<tbody><tr>
  				...
  				<td width="65%" valign="top" align="center"><strong>Heads of Income</strong></td>
  				<td width="140px" valign="top" align="center"><strong>Amount in Taka</strong></td>
  			</tr>
  			<tr>
  			...
  			<tr>
  				...
  				<td valign="middle" align="right">
	  				<?php 
	  					...
	  					//echo round($this->RebateAmount(Yii::app()->user->CPIId)); 
...
<!--       <tr>
    ...
    <tr>
    	<td valign="top" align="right">
    		Signature<br>
    		<?php echo strtoupper($personal_info_model->Name); ?><br>
...
<tr>
	<td valign="top" align="center"><br><br><br><br><br><br><br><br><br><br><br><br><br></td>
</tr><tr>
...
<tr>
	<td valign="top" align="center">
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					<td width="60%" valign="middle" align="left" style="font-size: 12px;">
						<strong>Name of the Assessee:</strong> <?php echo @$personal_info_model->Name; ?>
					</td>
					<td width="40%" valign="middle" align="right">
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tbody>
								...
								<td width="15%" valign="middle" align="left"><strong>TIN: </strong></td>
								<td width="85%" valign="middle" align="right">
									<table width="290" cellspacing="0" cellpadding="2" border="1">
										<tbody>
											<tr>
												<td valign="middle" align="center"><?php echo @$etin[0]; ?></td>
												<td valign="middle" align="center"><?php echo @$etin[1]; ?></td>
...
<tr>
	<td valign="top" align="center"><table width="100%" cellspacing="0" cellpadding="2" border="1">
		<tbody><tr>
			...
			<td width="120px" valign="top" align="center"></td>
		</tr>
		<tr>
			...
			<td valign="top" align="center">
				<table width="100%" cellspacing="0" cellpadding="2" border="1">
					<tbody><tr>
						...
						<td width="140px" valign="middle" align="right"><?php echo @$income_rebate_model->LifeInsurancePremium ?></td>
					</tr>
					<tr>
...
?>
        			<tr>
        				...
        				<td valign="top" align="right"><strong><?php echo ($totalIncome + $totalExemptedValue + $TotalOtherReceipts); ?></strong></td>
        			</tr>
        			<tr>
        				<td valign="middle" align="left"><strong>18. Difference</strong> (Between serial 16 and 17)</td>
        				<td valign="middle" align="left"><?php echo ($totalAccretion_16 - ($totalIncome + $totalExemptedValue + $TotalOtherReceipts)); ?></td>
        			</tr>
        		</tbody></table>
        	</td>
        </tr>
	...
	<td valign="top" align="center">
		<table width="100%" cellspacing="0" cellpadding="2" border="1">
			...
			<tr>
				...
				<td valign="middle" align="left"><?php echo $expence_model->PersonalFoodingComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">2</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->TotalTaxPaidLastYearComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">3</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->AccommodationComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">4</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->TransportComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">5</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->ElectricityBillComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">6</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->WasaBillComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">7</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->GasBillComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">8</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->TelephoneBillComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">9</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->ChildrenEducationComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">10</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->PersonalForeignTravelComment; ?></td>
			</tr>
			<tr>
				<td valign="middle" align="center">11</td>
				...
				<td valign="middle" align="left"><?php echo $expence_model->FestivalOtherSpecialComment; ?></td>
			</tr>
			<tr>
