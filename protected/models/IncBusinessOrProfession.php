...
/**
 * This is the model class for table "inc_business_or_profession".
 *
 * The followings are the available columns in table 'inc_business_or_profession':
 ...
 */
class IncBusinessOrProfession extends CActiveRecord
{
	public $SumOfBusinessOrProfession;

	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return IncBusinessOrProfession the static model class
	 */
	...
	{
		return 'inc_business_or_profession';
	}
	...
	{
		return array(
			'IncomeBusinessOrProfessionId' => 'Income Business Or Profession',
			'IncomeId' => 'Income',
			'Type' => 'Type',
