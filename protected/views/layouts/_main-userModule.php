  ...
  <div id="content" class="dashbord-bg" style="padding: 0px; ff">
    ...
    <!-- FLASH MESSAGE -->
      ...
      <div style="margin-top: 10px; margin-bottom: 10px;" class="alert alert-danger alert-dismissible" role="alert">
          <?php 
             echo Yii::t('dashboard',"<b>Important Notice -</b> BDTax.com.bd has been updated according to the Finance Act of 2017. Now you can prepare your 2017-2018 tax return using our system.");
          ?>
      </div>
      <?php endif; ?>
    <!-- END - FLASH MESSAGE -->
