...
/**
 * This is the model class for table "tmp_payments".
 *
 * The followings are the available columns in table 'tmp_payments':
 ...
 */
class TmpPayments extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TmpPayments the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('tran_id, role_id, payment_date, status', 'required'),
			...
			array('tran_id, payment_year, val_id, status, currency, card_brand, card_issuer_country, card_issuer_country_code, store_id, currency_type, risk_title', 'length', 'max'=>50),
