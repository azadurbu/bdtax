<div id="home-mid" class="reg-form income-dashbord">
	<div class="home_icon-box home_icon-5"></div>
	<h4><?=Yii::t("dashboard","Liabilities")?></h4>

	<div class="clearfix"></div>

	<p><?php //echo Yii::t("liability","<p>Demo Text (Information is not given)</p>")?></p>

	<!-- <h2><a href="<?=Yii::app()->baseUrl.'/index.php/liabilities/entry'?>"><?=Yii::t("common","Let's get started")?></a></h2> -->

	<?php 
	$haveLastYearDatas = Liabilities::model()->count('CPIId="'.Yii::app()->user->CPIId.'" and EntryYear="'.$this->lastTaxYear().'" order by LiabilityId DESC');

	if(isset($haveLastYearDatas) && $haveLastYearDatas == 1){?>
	<br><br><br><br><br>
	...
	<br><br><br><br><br>
	<?php }else{?>
	<h2><a href="<?=Yii::app()->baseUrl.'/index.php/liabilities/entry'?>"><?=Yii::t("expense","Let's get started")?></a></h2>
	<?php } ?>
<!-- Modal -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="pull-right" style="margin-right: 10px;">
				<a href='<?=Yii::app()->baseUrl.'/index.php/liabilities/entry'?>' class='btn btn-success for-clr'><?=Yii::t("assets","Yes")?></a>
			</div>
			<br>
        </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="pull-right" style="margin-right: 10px;">
				<a href='<?=Yii::app()->baseUrl.'/index.php/liabilities/copyLastyear'?>' class='btn btn-success for-clr'><?=Yii::t("assets","Yes")?></a>
			</div>
			<br>
        </div>
        <div class="modal-footer">
