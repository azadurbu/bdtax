...
/**
 * This is the model class for table "exp_surcharge_other".
 *
 * The followings are the available columns in table 'exp_surcharge_other':
 * @property integer $Id
 ...
 */
class ExpSurchargeOther extends CActiveRecord
{
	/**
