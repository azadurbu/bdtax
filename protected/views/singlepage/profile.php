		...
		<div class="reg-form income-dashbord nav-tabs-sticky-pi margin_bottom sticky-min-height">
			<div role="tabpanel" id="liabilities_tab">
				...
				<div class="tab-content">
					...
					<!-- #################-------------ETIN--------START----------################ -->
					<div role="tabpanel" class="tab-pane active" id="#PIDetails-single-1">
				
						

							
							<div class="clearfix"></div>
                            <h2> <?=Yii::t('p_info', "Please enter your Personal Information")?>&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips', "2.2")?>"></i></h2>
							<div class="mail-box">
							...
							<div class="mail-box">
								...
								<h3><?=Yii::t('p_info', "Please enter your e-TIN")?><span class="required">*</span>&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips', "2.1")?>"></i></h3>
								<div class="input-group margin-bottom-sm">
                            ...
                            <br/>
							<div class="mail-box">
								<div id="PersonalInformation_NID_error"></div>
							...
							<div class="info">
								<p>
									<label>
										<?php 
										    if ($model->GovernmentEmployee == '') {
											    $model->GovernmentEmployee = 'N';
										    }
										?>
...
echo CHtml::hiddenField('SC', $SC, array('id' => 'SC'));?>
	...
	<h3><?=Yii::t('p_info', "Mobile No")?><span class="required">*</span>&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips', "")?>"></i></h3>
			<div id="mobile_error"></div>
		<div class="col-lg-12">
			<?php 
				if($payments == 1){
					echo $form->textField($model, 'Contact', array('class' => 'form-control int_field', 'placeholder' =>Yii::t('p_info', "Mobile No."), 'id'=>'personalinfo_mobileno','readonly'=>'true', 'style'=>'cursor:pointer')); 
				}else{
...
<?php endif; ?>
	...
	<p class="button-padding">
		<button class="btn btn-success btn-lg" type="button" id="PIDetails-2_btn_single"><?=Yii::t('p_info', "Save & Continue")?></button>
	</p>
</div>
...
<div class="login-button input-group">
	...
	<?php if ($this->personalInformationStatusBar() >= 85){?>
		<div class="back pull-right">
			 <a class="btn btn-success for-clr" href="<?=Yii::app()->baseUrl?>/index.php/incomeSingle/startup" id="final_btn"><span class="previous-text"> <?=Yii::t('common', "Next")?> </span> <i class="fa fa-chevron-right"></i></a>
		</div>
    <?php } ?>
	<div class="clearfix"></div>
</div>
...
<script type="text/javascript">
    ...
    var pi_msg_nid ="<?php echo Yii::t('p_info', "Please enter the National Id"); ?>";
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/pi/pi_single.js?v=<?=$this->v?>"></script>
...
<script type="text/javascript">
    ...
    var incomeUrl = '<?php echo Yii::app()->request->baseUrl; ?>/index.php/incomeSingle/startup'
