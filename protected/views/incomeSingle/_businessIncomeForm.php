...
<!-- ================================================================== -->		
		   	<tr>
			    ...
			    <td>
			    	<div class="form-group">
			        	<input readonly value="<?php echo @$model3->IncomeFromBusiness1_1 ?>" type="text" autocomplete="off" onkeyup="calIncomeFromBusiness1Business(this.value)" class="form-control" id="IncIncomeBusinessOrProfession_IncomeFromBusiness1_1" name="IncIncomeBusinessOrProfession[IncomeFromBusiness1_1]" >
			        </div>
			    </td>
			    <td>
			        <div class="form-group">
			        	<input value="<?php echo @$model3->IncomeFromBusiness1 ?>" type="number" autocomplete="off"  class="form-control" id="IncIncomeBusinessOrProfession_IncomeFromBusiness1" name="IncIncomeBusinessOrProfession[IncomeFromBusiness1]" >
			        </div>
			    </td>
			    <td>
                    <div class="form-group">
                        <button type="button" class="btn btn-success" onclick="save_business_data('IncomeFromBusiness1', '<?php echo $model3->IncomeId;?>','<?php echo @$model3->IncomeFromBusiness1_1 ?>');"><?=Yii::t( 'income', "Save")?></button>
                ...
                <td>
                	<?php if($model3->IncomeId){?>
                    <div class="form-group">
                        <button type="button" class="btn btn-success" onclick="delete_business_data('IncomeFromBusiness1', '<?php echo $model3->IncomeId;?>');"><i class="fa fa-trash-o"></i> <?=Yii::t( 'income', "Delete")?></button>
...
<!-- ================================================================== -->		
		   	<tr class="business_row_2 <?php echo isset($model3->IncomeFromBusiness2_1)?'active':'';?> ">
				<td>
		        	<?php echo CHtml::activeLabelEx($model3, 'IncomeFromBusiness2', array( 'class'=> 'pull-left control-label', 'for' => 'inputMask', 'style' => 'color:#555555; text-align: left;')); ?> &nbsp;&nbsp;
			    </td>
			    <td>
			    	<div class="form-group">
			        	<input readonly value="<?php echo @$model3->IncomeFromBusiness2_1 ?>" type="text" autocomplete="off" onkeyup="calIncomeFromBusiness2Business(this.value)" class="form-control" id="IncIncomeBusinessOrProfession_IncomeFromBusiness2_1" name="IncIncomeBusinessOrProfession[IncomeFromBusiness2_1]" >
			        </div>
			    </td>
			    <td>
			        <div class="form-group">
			        	<input value="<?php echo @$model3->IncomeFromBusiness2 ?>" type="number" autocomplete="off"  class="form-control" id="IncIncomeBusinessOrProfession_IncomeFromBusiness2" name="IncIncomeBusinessOrProfession[IncomeFromBusiness2]" >
			        </div>
			    </td>
			    <td>

                    <div class="form-group">
                        <button type="button" class="btn btn-success" onclick="save_business_data('IncomeFromBusiness2', '<?php echo $model3->IncomeId;?>');"><?=Yii::t( 'income', "Save")?></button>
                ...
                <td>
                	<?php if($model3->IncomeId){?>
                    <div class="form-group">
                        <button type="button" class="btn btn-success" onclick="delete_business_data('IncomeFromBusiness2', '<?php echo $model3->IncomeId;?>');"><i class="fa fa-trash-o"></i> <?=Yii::t( 'income', "Delete")?></button>
...
<!-- ================================================================== -->		
		   	<tr class="business_row_3 <?php echo isset($model3->IncomeFromBusiness3_1)?'active':'';?>">
				<td>
		        	<?php echo CHtml::activeLabelEx($model3, 'IncomeFromBusiness3', array( 'class'=> 'pull-left control-label', 'for' => 'inputMask', 'style' => 'color:#555555; text-align: left;')); ?> &nbsp;&nbsp;
			    </td>
			    <td>
			    	<div class="form-group">
			        	<input readonly value="<?php echo @$model3->IncomeFromBusiness3_1 ?>" type="text" autocomplete="off" onkeyup="calIncomeFromBusiness3Business(this.value)" class="form-control" id="IncIncomeBusinessOrProfession_IncomeFromBusiness3_1" name="IncIncomeBusinessOrProfession[IncomeFromBusiness3_1]" >
			        </div>
			    </td>
			    <td>
			        <div class="form-group">
			        	<input value="<?php echo @$model3->IncomeFromBusiness3 ?>" type="number" autocomplete="off"  class="form-control" id="IncIncomeBusinessOrProfession_IncomeFromBusiness3" name="IncIncomeBusinessOrProfession[IncomeFromBusiness3]" >
			        </div>
			    </td>
			    <td>
                    <div class="form-group">
                        <button type="button" class="btn btn-success" onclick="save_business_data('IncomeFromBusiness3', '<?php echo $model3->IncomeId;?>');"><?=Yii::t( 'income', "Save")?></button>
                ...
                <td>
                	<?php if($model3->IncomeId){?>
                    <div class="form-group">
                        <button type="button" class="btn btn-success" onclick="delete_business_data('IncomeFromBusiness3', '<?php echo $model3->IncomeId;?>');"><i class="fa fa-trash-o"></i> <?=Yii::t( 'income', "Delete")?></button>
    ...
    <div class="addmore-button-container">
    <button class="btn btn-danger" type="button" onclick="ShowBusinessFrom()" ><i class="fa fa-plus"></i><?=Yii::t( 'income','Add more')?></button>
    </div>
    <p><?=Yii::t( 'income', "Don't you know your Taxable Income from Business and Profession? Please click the Details button")?></p>
</div>
...
function get_data(type,incomeId){
    ...
    $.ajax({
        url : baseUrl+"/index.php/IncomeSingle/getBusinessDetails",
        type : "POST",
        dataType : "json",
        cache : false,
        data : {
...
$( document ).ready(function() {
    if($('.business_row_2').hasClass('active') && $('.business_row_3').hasClass('active')){
    	$('.addmore-button-container').hide();
    }
    if($('.business_row_2').hasClass('active')){
    	activeBS=3;
    }
});

function ShowBusinessFrom(){
	
	$('.business_row_'+activeBS).show();
	if(!$('.business_row_'+activeBS).hasClass('active')){
		$('.business_row_'+activeBS).addClass('active');
		if($('.business_row_2').hasClass('active') && $('.business_row_3').hasClass('active')){
    	$('.addmore-button-container').hide();
        }
    }
...
<style type="text/css">
	.business_row_2,.business_row_3{display: none;}
	.business_row_2.active{display: contents;}
	.business_row_3.active{display: revert;}
	.addmore-button-container{clear:both;text-align: right;}
</style>