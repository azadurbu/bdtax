...
<table cellspacing="0" cellpadding="0" width="100%" border="1">
    ...
    ?>
		...
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php
          $minimumTaxValue = $this->minimumTaxValue(Yii::app()->user->CPIId);
    ...
    ?>
        ...
        <?php
          ...
          $maxValue = max($minimumTaxValue, $GrandTotalPayableTax);
          $grandTotalAmountPayable = $maxValue + $surCharge['surchargeAmount'];
		...
		<tr>
			...
			<td width="23%" style="padding:5px;" valign="top">
        <?php
          echo ($grandTotalAmountPayable - $total16);
        ?>
      </td>
		</tr>
		<tr>
	  ...
	  <td width="69%" colspan="3" valign="top" style="border: 1px solid #000; padding:5px;">
			<table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    ...
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top"><?php 
                    echo ($income_model['IncomeBusinessOrProfessionConfirm']=='Yes')?'<img border="0" width="20px" src="'.$tick.'" >':'&nbsp;';  ?></td>
                    <td width="10%" style="padding:5px;" valign="top">&nbsp;</td>
...
<table cellspacing="0" cellpadding="0" width="646">
    ...
    <?php 
      ...
      $percentageOfTotalIncome = ($totalIncome - @$this->totalOutputMain('ForeignIncome') - @$IncomeOtherSourceData->SanchaypatraIncome) *.25;
...
<table cellspacing="0" cellpadding="0" width="101%" border="1">
    ...
    ?>
		<tr>
			...
			<td width="21%" style="padding:5px;" valign="top">
				<p><?php echo number_format($shortage_of_fund, 2, '.', ''); ?></p>
			</td>
		</tr>
	</tbody>
</table>
