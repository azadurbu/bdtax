    ...
    <div class="data-container">
        <section class="login-rt">
                                ...
                                <table class="table table-bordred table-striped">
                                    ...
                                    <tbody id="mytable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input required value="<?php echo @$model->BasicPay ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_BasicPay_1" name="IncomeSalaries_BasicPay_1">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->SpecialPay_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_SpecialPay_1" name="IncomeSalaries[SpecialPay_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->SpecialPay_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_SpecialPay_2" name="IncomeSalaries_SpecialPay_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->DearnessAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_DearnessAllowance_1" name="IncomeSalaries[DearnessAllowance_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->DearnessAllowance_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_DearnessAllowance_2" name="IncomeSalaries_DearnessAllowance_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->ConveyanceAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_ConveyanceAllowance_1" name="IncomeSalaries[ConveyanceAllowance_1]">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->HouseRentAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_HouseRentAllowance_1" name="IncomeSalaries[HouseRentAllowance_1]">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->MedicalAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_MedicalAllowance_1" name="IncomeSalaries[MedicalAllowance_1]">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->ServantAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_ServantAllowance_1" name="IncomeSalaries[ServantAllowance_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->ServantAllowance_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_ServantAllowance_2" name="IncomeSalaries_ServantAllowance_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->LeaveAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_LeaveAllowance_1" name="IncomeSalaries[LeaveAllowance_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->LeaveAllowance_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_LeaveAllowance_2" name="IncomeSalaries_LeaveAllowance_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->HonorariumOrReward ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_HonorariumOrReward_1" name="IncomeSalaries[HonorariumOrReward]">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->OvertimeAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_OvertimeAllowance_1" name="IncomeSalaries[OvertimeAllowance_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->OvertimeAllowance_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_OvertimeAllowance_2" name="IncomeSalaries_OvertimeAllowance_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->Bonus ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_Bonus_1" name="IncomeSalaries_Bonus_1">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->OtherAllowances_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_OtherAllowances_1" name="IncomeSalaries[OtherAllowances_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->OtherAllowances_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_OtherAllowances_2" name="IncomeSalaries_OtherAllowances_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p class="contribution-income" style="color:red;font-size: 12px;float:left;display: none;">Please enter your contribution provident fund amount to both <br/> Tax Rebate and Cash Asset page.</p>
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->EmployersContributionProvidentFund_1 ?>" type="text" autocomplete="off" onclick="showwarning('contribution-income')" onkeyup="onGovtRuleTaxCal(this)" onblur="hidewarning('contribution-income')" class="form-control" id="IncomeSalaries_EmployersContributionProvidentFund_1" name="IncomeSalaries[EmployersContributionProvidentFund_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->EmployersContributionProvidentFund_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_EmployersContributionProvidentFund_2" name="IncomeSalaries_EmployersContributionProvidentFund_2">
                                            </td>
                                            <td>
			...
			<span class="text">YES</span>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->InterestAccruedProvidentFund_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_InterestAccruedProvidentFund_1" name="IncomeSalaries[InterestAccruedProvidentFund_1]">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo CHtml::activeLabelEx($model, 'DeemedIncomeTransport', array( 'class'=> 'pull-left control-label', 'for' => 'inputMask', 'style' => 'color:#555555')); ?> &nbsp;&nbsp;
                                                <i class="fa fa-question-circle fa-1" /*data-toggle="tooltip" */ title="<?=Yii::t('TTips', "6.15")?>"></i>
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->DeemedIncomeTransport_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_DeemedIncomeTransport_1" name="IncomeSalaries[DeemedIncomeTransport_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->DeemedIncomeTransport_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_DeemedIncomeTransport_2" name="IncomeSalaries_DeemedIncomeTransport_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->DeemedFreeAccommodation_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_DeemedFreeAccommodation_1" name="IncomeSalaries[DeemedFreeAccommodation_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->DeemedFreeAccommodation_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_DeemedFreeAccommodation_2" name="IncomeSalaries_DeemedFreeAccommodation_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <!--td>
                                                <?php //echo CHtml::activeLabelEx($model, 'FestivalBonus', array( 'class'=> 'pull-left control-label', 'for' => 'inputMask', 'style' => 'color:#555555')); ?> &nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <input value="<?php //echo @$model->FestivalBonus_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_FestivalBonus_1" name="IncomeSalaries[FestivalBonus_1]">
                                            </td>
                                            <td>
                                                
                                                <input value="<?php //echo @$model->FestivalBonus_2 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_FestivalBonus_2" name="IncomeSalaries[FestivalBonus_2]">
                                            </td>
                                            <td>
                                                <?php //echo $form->textField($model, 'FestivalBonus', array('readonly' => 'readonly', 'class' => 'form-control')); ?>
                                                <br/>
                                                <?php echo $form->error($model, 'FestivalBonus'); ?>
                                            </td>
                                        </tr -->

                                        <tr>
                                            <td>
                                                <input value="<?php echo @$model->FestivalBonus_1 ?>" type="hidden" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_FestivalBonus_1" name="IncomeSalaries[FestivalBonus_1]">
                                                <?php echo CHtml::activeLabelEx($model, 'BengaliNewYearBonus', array( 'class'=> 'pull-left control-label', 'for' => 'inputMask', 'style' => 'color:#555555')); ?> &nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->BengaliNewYearBonus_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_BengaliNewYearBonus_1" name="IncomeSalaries[BengaliNewYearBonus_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->BengaliNewYearBonus_2 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_BengaliNewYearBonus_2" name="IncomeSalaries[BengaliNewYearBonus_2]">
                                            </td>
                                            <td>
                                                <?php echo $form->textField($model, 'BengaliNewYearBonus', array('readonly' => 'readonly', 'class' => 'form-control')); ?>
                                                <br/>
                                                <?php echo $form->error($model, 'BengaliNewYearBonus'); ?>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <?php echo CHtml::activeLabelEx($model, 'EntertainmentAllowance', array( 'class'=> 'pull-left control-label', 'for' => 'inputMask', 'style' => 'color:#555555')); ?> &nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->EntertainmentAllowance_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_EntertainmentAllowance_1" name="IncomeSalaries[EntertainmentAllowance_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->EntertainmentAllowance_2 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_EntertainmentAllowance_2" name="IncomeSalaries[EntertainmentAllowance_2]">
                                            </td>
                                            <td>
                                                <?php echo $form->textField($model, 'EntertainmentAllowance', array('readonly' => 'readonly', 'class' => 'form-control')); ?>
                                                <br/>
                                                <?php echo $form->error($model, 'EntertainmentAllowance'); ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->Others_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_Others_1" name="IncomeSalaries[Others_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->Others_1 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_Others_2" name="IncomeSalaries_Others_2">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->Arear_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_Arear_1" name="IncomeSalaries[Arear_1]">
                                            </td>
                                            <td>
                                                <input value="<?php echo @$model->Arear_2 ?>" type="text" readonly='readonly' class="form-control" id="IncomeSalaries_Arear_2" name="IncomeSalaries[Arear_2]">
                                            </td>
                                            <td>
                            ...
                            <div class="panel-footer">
                                ...
                                <div class="pull-left" style="padding:0 10px;">
                                    <a class="btn btn-success" href="<?=Yii::app()->baseUrl?>/index.php/income/entry#s_7">
                                        <?=Yii::t( 'income', "Cancel") ?>
                                    </a>
                                </div>
