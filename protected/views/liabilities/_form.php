...
<div class="reg-form income-dashbord nav-tabs-sticky sticky-min-height">
  <div role="tabpanel" id="liabilities_tab">
    ...
    <ul class="nav nav-tabs" role="tablist" id="myTab">
      ...
      <li role="presentation" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"5.4")?>"><a href="#others_loan" role="tab" data-toggle="tab"> <?=($OthersLoanCount == 0) ? '':'<i class="fa fa-check-square"></i> ' ?> <?=Yii::t("liability","Other Liabilities") ?></a></li>

    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
      <div class="back pull-right">
       <a class="btn btn-success for-clr" href="<?=Yii::app()->baseUrl ?>/index.php/liabilities/review" ><span class="previous-text"> <?=Yii::t('common', "Review")?> </span><i class="glyphicon glyphicon-list-alt"></i></a>
     </div>
...
##############################################################################
-->
<h2><?=Yii::t("liability","Mortgages")?>&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"5.1")?>"></i></h2>                                   
...
<div id="mortgages_on_property_verification" style="display: <?=($model->MortgagesOnPropertyConfirm == 'Yes') ? 'none':'block' ?>;">
  ...
  <h3>
    <div class="btn-group btn-group-lg">
      <button onclick="show_divs('mortgages_on_property_verification', 'mortgages_on_property_fraction_or_total', 'mortgages_on_property_total')" type="button" class="btn btn-big btn-<?=($model->MortgagesOnPropertyConfirm == 'Yes')? 'success' : 'default' ?>"><?=Yii::t("common","YES")?></button>
      <button onclick="set_no('MortgagesOnProperty')" type="button" class="btn btn-big btn-<?=($model->MortgagesOnPropertyConfirm == 'No')? 'success' : 'default' ?>"><?=Yii::t("common","NO")?></button>
    </div>
  </h3>
  <!-- END YES/NO BUTTON -->
</div>
...
<div id="mortgages_on_property_fraction_or_total" style="display: <?=($model->MortgagesOnPropertyConfirm == 'Yes') ? 'block':'none' ?>;">
 ...
 <div id="mortgages_on_property_total" style="display: <?=($model->MortgagesOnPropertyFOrT != 'Fraction') ? 'block':'none' ?>;">
  ...
  <button onclick="show_divs('mortgages_on_property_total', 'mortgages_on_property_fraction', 'no')" type="button" class="btn btn-xs btn-success"><?=Yii::t("common","Breakdown")?></button>
  ...
  <p>
    <br>
    <br>
    <button class="btn btn-success btn-lg" onclick="save_liabilities('MortgagesOnProperty')" type="button" ><?=Yii::t('common', "Store")?></button>
  </p>
  <!-- END - ENTRY FORM -->
...
<div id="mortgages_on_property_fraction" style="display: <?=($model->MortgagesOnPropertyFOrT == 'Fraction') ? 'block':'none' ?>;" class="col-sm-8 col-sm-offset-2">
  <table class="table" id="mortgages_on_property_table">
    <thead>
      <tr>
        ...
        <th><?=Yii::t("liability","Value (BDT)")?></th>
        <th></th>
      </tr>
    </thead>
    <tbody>
  ...
  <button class="btn btn-success btn-lg" onclick="save_liabilities_fraction('mortgages_on_property_id', 'mortgages_on_property_description', 'mortgages_on_property_cost', 'LiaMortgagesOnProperty', 'MortgagesOnProperty')" type="button" ><?=Yii::t('common', "Store")?></button>
...
<div class="login-button input-group">
  <div class="back pull-right">
    <a class="btn btn-success for-clr" data-toggle="tab" href="#unsecured_loans" onclick="next_pre('unsecured_loans')" ><span class="previous-text"> <?=Yii::t("common","Next")?> </span><i class="fa fa-chevron-right"></i></a>
  </div>
  <div class="clearfix"></div>
</div>
...
##############################################################################
-->
<h2><?=Yii::t("liability","Unsecured Loans")?>&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"5.2")?>"></i></h2>                                   
<div class="clearfix"></div>
...
<div id="unsecured_loans_verification" style="display: <?=($model->UnsecuredLoansConfirm == 'Yes') ? 'none':'block' ?>;">
  ...
  <h3>
    <div class="btn-group btn-group-lg">
      <!-- <button onclick="show_divs('unsecured_loans_verification', 'unsecured_loans_fraction_or_total', 'unsecured_loans_total')" type="button" class="btn btn-big btn-<?=($model->UnsecuredLoansConfirm == 'Yes')? 'success' : 'default' ?>"><?=Yii::t("common","YES")?></button> -->
      
      <button onclick="show_divs('unsecured_loans_verification', 'unsecured_loans_fraction_or_total', 'unsecured_loans_fraction')" type="button" class="btn btn-big btn-<?=($model->UnsecuredLoansConfirm == 'Yes')? 'success' : 'default' ?>"><?=Yii::t("common","YES")?></button>

      <button onclick="set_no('UnsecuredLoans')" type="button" class="btn btn-big btn-<?=($model->UnsecuredLoansConfirm == 'No')? 'success' : 'default' ?>"><?=Yii::t("common","NO")?></button>
    </div>
  </h3>
  <!-- END YES/NO BUTTON -->
</div>
...
<div id="unsecured_loans_fraction_or_total" style="display: <?=($model->UnsecuredLoansConfirm == 'Yes') ? 'block':'none' ?>;">
 ...
 <!-- <div id="unsecured_loans_total" style="display: <?=($model->UnsecuredLoansFOrT != 'Fraction') ? 'block':'none' ?>;"> -->
  ...
  <div id="unsecured_loans_total" style="display: none;">
  <!-- show saved data -->    
  <p class="exp_alert">
  ...
  <!-- end - show saved data -->
  <?=Yii::t("liability","You can enter total annual data below or you can breakdown your data")?>
  <button onclick="show_divs('unsecured_loans_total', 'unsecured_loans_fraction', 'no')" type="button" class="btn btn-xs btn-success"><?=Yii::t("common","Breakdown")?></button>
  ...
  <p>
    <br>
    <br>
    <button class="btn btn-success btn-lg" onclick="save_liabilities('UnsecuredLoans')" type="button" ><?=Yii::t('common', "Store")?></button>
  </p>
  <!-- END - ENTRY FORM -->
...
<div id="unsecured_loans_fraction" style="display: <?=($model->UnsecuredLoansFOrT == 'Fraction') ? 'block':'none' ?>;" class="col-sm-8 col-sm-offset-2">
      ...
      <tr>
        <td>
          <div class="form-group">
            ...
            <textarea id="unsecured_loans_description" class="form-control" rows="3" placeholder="<?=Yii::t("liability", "Description (Mention your Name & TIN number)")?>"></textarea>
          </div>
        </td>
        <td>
          <div class="form-group">
  ...
  <button class="btn btn-success btn-lg" onclick="save_liabilities_fraction('unsecured_loans_id', 'unsecured_loans_description', 'unsecured_loans_cost', 'LiaUnsecuredLoans', 'UnsecuredLoans')" type="button" ><?=Yii::t('common', "Store")?></button>
...
<div class="login-button input-group">
  <div class="back pull-left">
    <a class="btn btn-success for-clr" data-toggle="tab" href="#mortgages_on_property" onclick="next_pre('mortgages_on_property')" ><i class="fa fa-chevron-left"></i> <span class="previous-text">  <?=Yii::t("common","Previous")?> </span></a>
  </div>
  <div class="back pull-right">
   <a class="btn btn-success for-clr" data-toggle="tab" href="#bank_loans" onclick="next_pre('bank_loans')" ><span class="previous-text"> <?=Yii::t("common","Next")?> </span> <i class="fa fa-chevron-right"></i></a>
  </div>
  <div class="clearfix"></div>
</div>
<!-- END - NEXT PREVIOUS BUTTON -->
...
<div id="bank_loans_verification" style="display: <?=($model->BankLoansConfirm == 'Yes') ? 'none':'block' ?>;">
  ...
  <h3>
    <div class="btn-group btn-group-lg">
      <button onclick="show_divs('bank_loans_verification', 'bank_loans_fraction_or_total', 'bank_loans_total')" type="button" class="btn btn-big btn-<?=($model->BankLoansConfirm == 'Yes')? 'success' : 'default' ?>"><?=Yii::t("common","YES")?></button>
      <button onclick="set_no('BankLoans')" type="button" class="btn btn-big btn-<?=($model->BankLoansConfirm == 'No')? 'success' : 'default' ?>"><?=Yii::t("common","NO")?></button>
    </div>
  </h3>
  <!-- END YES/NO BUTTON -->
</div>
...
<div id="bank_loans_fraction_or_total" style="display: <?=($model->BankLoansConfirm == 'Yes') ? 'block':'none' ?>;">
 ...
 <div id="bank_loans_total" style="display: <?=($model->BankLoansFOrT != 'Fraction') ? 'block':'none' ?>;">
  ...
  <!-- end - show saved data -->
  <?=Yii::t("liability","You can enter total annual data below or you can breakdown your data")?>
  <button onclick="show_divs('bank_loans_total', 'bank_loans_fraction', 'no')" type="button" class="btn btn-xs btn-success"><?=Yii::t("common","Breakdown")?></button>
  
  <!-- ENTRY FORM -->
  <p><?=Yii::t("liability","Please enter your bank loan liabilities")?></p>
  <div class="col-sm-12">
    <div class="col-sm-4 col-sm-offset-4">
      <?php echo $form->textField($model,'BankLoansTotal',array('class'=>'form-control', 'placeholder'=>Yii::t("liability", "Bank Loans")) ); ?>
    </div>
    <div class="col-sm-1">
  ...
  <p>
    <br>
    <br>
    <button class="btn btn-success btn-lg" onclick="save_liabilities('BankLoans')" type="button" ><?=Yii::t('common', "Store")?></button>
  </p>
  <!-- END - ENTRY FORM -->
...
<div id="bank_loans_fraction" style="display: <?=($model->BankLoansFOrT == 'Fraction') ? 'block':'none' ?>;" class="col-sm-8 col-sm-offset-2">
  ...
  <button class="btn btn-success btn-lg" onclick="save_liabilities_fraction('bank_loans_id', 'bank_loans_description', 'bank_loans_cost', 'LiaBankLoans', 'BankLoans')" type="button" ><?=Yii::t('common', "Store")?></button>
...
<div class="login-button input-group">
  <div class="back pull-left">
    <a class="btn btn-success for-clr" data-toggle="tab" href="#unsecured_loans" onclick="next_pre('unsecured_loans')" ><i class="fa fa-chevron-left"></i> <span class="previous-text">  <?=Yii::t("common","Previous")?> </span></a>
  </div>
  <div class="back pull-right">
   <a class="btn btn-success for-clr" data-toggle="tab" href="#others_loan" onclick="next_pre('others_loan')" ><span class="previous-text"> <?=Yii::t("common","Next")?> </span> <i class="fa fa-chevron-right"></i></a>
  </div>
  <div class="clearfix"></div>
</div>
<!-- END - NEXT PREVIOUS BUTTON -->
...
##############################################################################
-->
<h2><?=Yii::t("liability","Other Liabilities")?>&nbsp;&nbsp;<i class="fa fa-question-circle fa-1" /*data-toggle="tooltip"*/ title="<?=Yii::t('TTips',"5.4")?>"></i></h2>                                   
<div class="clearfix"></div>
...
<div id="others_loan_verification" style="display: <?=($model->OthersLoanConfirm == 'Yes') ? 'none':'block' ?>;">
  ...
  <h3>
    <div class="btn-group btn-group-lg">
      <button onclick="show_divs('others_loan_verification', 'others_loan_fraction_or_total', 'others_loan_total')" type="button" class="btn btn-big btn-<?=($model->OthersLoanConfirm == 'Yes')? 'success' : 'default' ?>"><?=Yii::t("common","YES")?></button>
      <button onclick="set_no('OthersLoan')" type="button" class="btn btn-big btn-<?=($model->OthersLoanConfirm == 'No')? 'success' : 'default' ?>"><?=Yii::t("common","NO")?></button>
    </div>
  </h3>
  <!-- END YES/NO BUTTON -->
</div>
...
<div id="others_loan_fraction_or_total" style="display: <?=($model->OthersLoanConfirm == 'Yes') ? 'block':'none' ?>;">
 ...
 <div id="others_loan_total" style="display: <?=($model->OthersLoanFOrT != 'Fraction') ? 'block':'none' ?>;">
  ...
  <!-- end - show saved data -->
  <?=Yii::t("liability","You can enter total annual data below or you can breakdown your data")?>
  <button onclick="show_divs('others_loan_total', 'others_loan_fraction', 'no')" type="button" class="btn btn-xs btn-success"><?=Yii::t("common","Breakdown")?></button>
  
  <!-- ENTRY FORM -->
  <p><?=Yii::t("liability","Please enter your Other liabilities")?></p>
  <div class="col-sm-12">
    <div class="col-sm-4 col-sm-offset-4">
      <?php echo $form->textField($model,'OthersLoanTotal',array('class'=>'form-control', 'placeholder'=>Yii::t("liability", "Other Liabilities")) ); ?>
    </div>
    <div class="col-sm-1">
  ...
  <p>
    <br>
    <br>
    <button class="btn btn-success btn-lg" onclick="save_liabilities('OthersLoan')" type="button" ><?=Yii::t('common', "Store")?></button>
  </p>
  <!-- END - ENTRY FORM -->
...
<div id="others_loan_fraction" style="display: <?=($model->OthersLoanFOrT == 'Fraction') ? 'block':'none' ?>;" class="col-sm-8 col-sm-offset-2">
  ...
  <button class="btn btn-success btn-lg" onclick="save_liabilities_fraction('others_loan_id', 'others_loan_description', 'others_loan_cost', 'LiaOthersLoan', 'OthersLoan')" type="button" ><?=Yii::t('common', "Store")?></button>
...
<div class="login-button input-group">
    <div class="back pull-left">
      <a class="btn btn-success for-clr" data-toggle="tab" href="#bank_loans" onclick="next_pre('child_edu_expenses')" ><i class="fa fa-chevron-left"></i><span class="previous-text">  <?=Yii::t("common","Previous")?> </span></a>
    </div>
    <div class="back pull-right">
        <a class="btn btn-success for-clr" href="<?=Yii::app()->baseUrl ?>/index.php/liabilities/review"><span class="previous-text"><?=Yii::t("income","Next")?></span> <i class="fa fa-chevron-right"></i></a>
    </div>
