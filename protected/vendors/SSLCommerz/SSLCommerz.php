...
class SSLCommerz {
                        ...
                        if(isset($this->sslc_data['gw']['visa']) &&  $this->sslc_data['gw']['visa']!=""){
                            ...
                            foreach($sslcz_visa as $gw_value) {
                                ...
                                if($gw_value=='visacard') {
                                    ...
                                    $options['cards'][4]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."visacard'><img style='width:60px; height:60px' src='".$this->_get_image("visacard", $this->sslc_data)."' alt='VISA'/></a>";
                                    
                                    $options['cards'][4]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."visacard";
                                    $options['cards'][4]['gw'] = $gw_value;
                        ...
                        if(isset($this->sslc_data['gw']['master']) &&  $this->sslc_data['gw']['master']!=""){
                            ...
                            foreach($sslcz_visa as $gw_value) {
                                ...
                                if($gw_value=='mastercard') {
                                    ...
                                    $options['cards'][9]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."mastercard'><img style='width:60px; height:60px' src='".$this->_get_image("mastercard", $this->sslc_data)."' alt='MASTER'/></a>";

                                    $options['cards'][9]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."mastercard";
                                    $options['cards'][9]['gw'] = $gw_value;
                                }
                            }
                        } # END OF MASTER
                        ...
                        if(isset($this->sslc_data['gw']['amex']) &&  $this->sslc_data['gw']['amex']!=""){
                            ...
                            foreach($sslcz_visa as $gw_value) {
                                if($gw_value=='city_amex') {
                                    ...
                                    $options['cards'][10]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."city_amex'><img style='width:60px; height:60px' src='".$this->_get_image("city_amex", $this->sslc_data)."' alt='AMEX'/></a>";

                                    $options['cards'][10]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."city_amex";
                                    $options['cards'][10]['gw'] = $gw_value;
                                }
                        ...
                        if(isset($this->sslc_data['gw']['othercards']) &&  $this->sslc_data['gw']['othercards']!=""){
                            ...
                            foreach($sslcz_visa as $gw_value) {
                                if($gw_value=='dbbl_nexus') {
                                    ...
                                    $options['others'][0]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."dbbl_nexus'><img style='width:60px; height:60px' src='".$this->_get_image("dbbl_nexus", $this->sslc_data)."' alt='NEXUS'/></a>";

                                    $options['others'][0]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."dbbl_nexus";
                                    $options['others'][0]['gw'] = $gw_value;
                                }
                                ...
                                if($gw_value=='qcash') {
                                    ...
                                    $options['others'][1]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."qcash";
                                    $options['others'][1]['gw'] = $gw_value;
                                }
                                ...
                                if($gw_value=='fastcash') {
                                    ...
                                    $options['others'][2]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."fastcash";
                                    $options['others'][2]['gw'] = $gw_value;
                                }
                            }
                        } # END OF OTHER CARDS
                        ...
                        if(isset($this->sslc_data['gw']['internetbanking']) &&  $this->sslc_data['gw']['internetbanking']!=""){
                            ...
                            foreach($sslcz_visa as $gw_value) {
                                if($gw_value=='city') {
                                    ...
                                    $options['internet'][0]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."city'><img style='width:60px; height:60px' src='".$this->_get_image("city", $this->sslc_data)."' alt='CITYTOUCH'/></a>";

                                    $options['internet'][0]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."city";
                                    $options['internet'][0]['gw'] = $gw_value;
                                }

                                if($gw_value=='bankasia') {
                                    $options['internet'][1]['name'] = "BANK ASIA";
                                    $options['internet'][1]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."bankasia'><img style='width:60px; height:60px' src='".$this->_get_image("bankasia", $this->sslc_data)."' alt='BANK ASIA'/></a>";

                                    $options['internet'][1]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."bankasia";
                                    $options['internet'][1]['gw'] = $gw_value;
                                }
                                ...
                                if($gw_value=='ibbl') {
                                    ...
                                    $options['internet'][2]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."ibbl";
                                    $options['internet'][2]['gw'] = $gw_value;
                                }
                                ...
                                if($gw_value=='mtbl') {
                                    ...
                                    $options['internet'][3]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."mastercard";
                                    $options['internet'][3]['gw'] = $gw_value;
                                }
                            }
                        ...
                        if(isset($this->sslc_data['gw']['mobilebanking']) &&  $this->sslc_data['gw']['mobilebanking']!=""){
                            ...
                            foreach($sslcz_visa as $gw_value) {
                                if($gw_value=='dbblmobilebanking') {
                                    $options['mobile'][0]['name'] = "DBBL MOBILE<br>BANKING";
                                    $options['mobile'][0]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."dbblmobilebanking'><img style='width:60px; height:60px' src='".$this->_get_image("dbblmobilebanking", $this->sslc_data)."' alt='DBBL MOBILE BANKING'/></a>";

                                    $options['mobile'][0]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."dbblmobilebanking";
                                    $options['mobile'][0]['gw'] = $gw_value;
                                }
                                ...
                                if($gw_value=='bkash') {
                                    ...
                                    $options['mobile'][1]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."bkash";
                                    $options['mobile'][1]['gw'] = $gw_value;
                                }

                                if($gw_value=='abbank') {
                                    $options['mobile'][2]['name'] = "AB Direct";
                                    $options['mobile'][2]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."abbank'><img style='width:60px; height:60px' src='".$this->_get_image("abbank", $this->sslc_data)."' alt='AB Direct'/></a>";

                                    $options['mobile'][2]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."abbank";
                                    $options['mobile'][2]['gw'] = $gw_value;
                                }

                                if($gw_value=='m_ibbl') {
                                    $options['mobile'][3]['name'] = "IBBL Mobile Banking";
                                    $options['mobile'][3]['link'] =  "<a class='hvr-pop' href='".$this->sslc_data['redirectGatewayURL']."m_ibbl'><img style='width:60px; height:60px' src='".$this->_get_image("m_ibbl", $this->sslc_data)."' alt='IBBL Mobile Banking'/></a>";

                                    $options['mobile'][3]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."ibbl";
                                    $options['mobile'][3]['gw'] = $gw_value;
                                }
                                ...
                                if($gw_value=='mycash') {
                                    ...
                                    $options['mobile'][4]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."mycash";
                                    $options['mobile'][4]['gw'] = $gw_value;
                                }
                                ...
                                if($gw_value=='ific') {
                                    ...
                                    $options['mobile'][5]['raw_link'] =  $this->sslc_data['redirectGatewayURL']."ific";
                                    $options['mobile'][5]['gw'] = $gw_value;
                                }
                            }
    ...
    protected function _get_image($gw="", $source=array()){
        $logo = "https://securepay.sslcommerz.com/gwprocess/v3/image/gw/amex.png";
        if(!empty($source) && isset($source['desc'])) {
            ...
            return $logo;
        } else { return "https://securepay.sslcommerz.com/gwprocess/v3/image/gw/amex.png";}
    }
