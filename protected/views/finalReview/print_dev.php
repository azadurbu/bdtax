...
<div id="home-mid" class="reg-form income-dashbord">
  ...
  <h4 style="color:#b90601; text-transform:uppercase; font-size:26px; font-weight:bold;"><?=Yii::t("liability", "Download") ?></h4>
...
?>
    ...
    <?php endif; ?>
      ...
      <a href="<?php echo Yii::app()->baseUrl; ?>/index.php/userSignature/" class="btn btn-success" style="margin-bottom: 10px;"><b><?=Yii::t("liability", "Step") ?> <?= ++$step ?>:</b> <?=Yii::t("liability", "Add Your Signature") ?></a>
...
<br />
<p style="padding-top:10px;"><?=Yii::t("liability", "Thank you for using bdtax.com.bd. Please share your experience via facebook.") ?></p>
      ...
      <div class="modal-header panel-heading">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
            ...
            <h3 class="panel-title">Refer Your Friends</h3> 
          ...
          <div class="col-lg-12">
            ...
            $form = $this->beginWidget('UActiveForm', array(
              ...
              <div class="row">
                ...
                <div class="col-lg-10">
                  <div style="max-height: 400px; min-height: 150px; overflow-y: scroll; margin-top: 20px; overflow-x: hidden;">
                    <style>

                      table#refer_friend td, table th {
                        padding: 5px 3px !important; 
                      }
                      table#refer_friend {
                        padding: 12px !important;
                      }
            #referFriendModal .modal-header .close {
              margin-right:10px;
            }
            ...
            .dataTables_wrapper .dataTables_filter label{
              width: 100%;
                    ...
                    <div class="table-responsive">
                      ...
                      <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Search For Your Friends</h3>
                            </div>
            </div> 
                      
                            <div class="clear-fix"></div>
                            <table id="refer_friend" class="table table-bordred table-striped table-hove" width="100%">
                                <thead>
                                  <tr>
                                    <td width="20"><input type="checkbox" id="check_all" value="check_all"></td>
                                    <td>Check All</td>
                                  </tr>
                                </thead>
                                <tbody>
                                  <?php foreach ($referEmails as $title) { ?>
                                  <tr>
                                    <td width="20"><input type="checkbox" class="email_address" name="email_address[]" value="<?=$title->attributes()->address?>"></td>
                                    <td><?=$title->attributes()->address?></td>
                                  </tr>
                  ...
                  <div class="form-actions" style="padding-top: 10px;">
                    <?php 
                    if (!empty($referEmails)) {
                      $this->widget('bootstrap.widgets.TbButton', array(
                        'buttonType'=>'submit',
                        'type'=>'success',
                        'label'=> 'Refer Friends',
                        'htmlOptions' => array(
                          'name' => 'referFriendSubmit',
                          ),
                        )); 
                    }
                    ?>
