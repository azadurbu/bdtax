...
<head>
  ...
  fbq('init', '1651835461775984');
  fbq('track', 'PageView');
  </script>
  <noscript><img height="1" width="1" style="display:none"
  src=" https://www.facebook.com/tr?id=1651835461775984&ev=PageView&noscript=1"
  /></noscript>
  <!-- DO NOT MODIFY -->
  ...
  <div class="container">
    <div class="col-md-12 social">
      ...
      <div class=" pull-right hide">
        <a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/fc-icon.png"></a>
        <a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/twitter_icon.png"></a>
        <a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/sc-icon.png"></a>
        <?php if ((Yii::app()->user->name != 'Guest')) {?>
          <div class="alert alert-success" style="margin-bottom:0px; padding:7px">
            <?php echo "Welcome, " . Yii::app()->user->name; ?>&nbsp;&nbsp;</div>
            <?php echo CHtml::link(Yii::app()->getModule('user')->t("Logout"), Yii::app()->getModule('user')->logoutUrl, array('class' => 'label label-success', "style" => "padding:11px;")); ?>
          </div>
          <?php }
      ?>
        </div>
        ...
        <div class="col-md-7">
      <div class="row">
            <div class="col-lg-12" id="language-selector" style="float:right; margin-top:0px;">
            <div class="row facbook-like-top" style="text-align: right;">  

            <div style="padding: 0px 40px 0 0;" class="fb-like bdtax_fb_like" data-href="https://www.facebook.com/bdtaxonline" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>
          <?php
                  ...
                  <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                      <ul class="nav navbar-nav menu">
                        <li ><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php"><?php echo Yii::t('user', "Home"); ?></a></li>
                        <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/page?view=about"><?php echo Yii::t('user', "About Us"); ?></a></li>
                        
                        <li <?php echo ($this->id == 'site' && $this->action->id == 'page' && $_GET['view'] == 'howtouse') ? ' class="active"':''; ?> ><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/page?view=howtouse"><?php echo Yii::t('user', "How to"); ?></a></li>

                          <li <?php echo ($ctrlName == 'registration' && ($actionName == 'individual'||$actionName == 'registerIndividual')) ? ' class="active"':''; ?>><a href="<?=Yii::app()->request->baseUrl?>/index.php/user/registration/registerIndividual"><?php echo Yii::t('user', "Individuals"); ?></a></li>
                          <li <?php echo ($ctrlName == 'registration' && ($actionName == 'company'||$actionName == 'registercompany')) ?' class="active"':''; ?>><a href="<?=Yii::app()->request->baseUrl?>/index.php/user/registration/registercompany"><?php echo Yii::t('user', "Companies"); ?></a></li>

                          <!--  <li <?php echo ($this->id == 'registration' && $this->action->id != 'index') ? ' class="active"':''; ?>><a href="<?=Yii::app()->request->baseUrl?>/index.php/user/registration"><?php echo Yii::t('user', "Plans"); ?></a></li>-->

<!--
                        <li <?php echo ($this->id == 'site' && $this->action->id == 'page' && $_GET['view'] == 'audit') ? ' class="active"':''; ?> ><a href="<?php //echo Yii::app()->request->baseUrl; ?>/index.php/site/page?view=audit"><?php //echo Yii::t('user', "Audit"); ?></a></li>
-->
                          <!-- <li><a href="https://bdtax.freshdesk.com/support/home" target="_blank"><?php echo Yii::t('user', "Support"); ?></a></li> -->

                          <li><a href="https://blog.bdtax.com.bd/" target="_blank"><?php echo Yii::t('user', "Blog"); ?></a></li>


                          <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/contact"><?php echo Yii::t('user', "Contact Us"); ?></a></li>
                      </ul>
                    </div><!--/.nav-collapse -->
                  </div><!--/.container-fluid -->
                </nav>
...
<div class="footer_top">
  <div class="container">
    <div class="col-lg-4">
      <h3 class="about_bd" id="about_bd"><?php echo Yii::t('user', "About Us"); ?></h3><hr>
      <div class="f_logo"></div>
      <p class="aliquam_enim">
        <?php echo Yii::t('user', "aboutUs_text"); ?> <a href="<?=Yii::app()->request->baseUrl?>/index.php/user/registration"><?php echo Yii::t('user', "FREE"); ?></a><?php echo Yii::t('user', "."); ?>
      </p>
    </div>

    <div class="col-lg-4">
<div id="likebox-wrapper">
    <div class="fb-page" data-href="https://www.facebook.com/bdtaxcombd-211164105753344/" data-height="385" data-small-header="false" data-adapt-container-width="true" data-hide-cover="true" data-show-facepile="true" data-show-posts="true"></div>
<!--       <h3 class="about_bd"><?php echo Yii::t('user', "Helpful Links"); ?></h3><hr>
      <div class="footer_tex">
        <p class="news"><?php echo Yii::t('user', "National Board of Revenue (NBR)"); ?><p>
          <a href="http://www.nbr.gov.bd/">www.nbr.gov.bd/</a>
        </div>

        <div class="footer_tex">
          <p class=""><?php echo Yii::t('user', "e-TIN Registration"); ?> <p>
            <a href="www.incometax.gov.bd">www.incometax.gov.bd</a>
          </div>

          <div class="footer_tex">
            <p class="news"><?php echo Yii::t('user', "NBR Tax Calculator"); ?> <p>
              <a href="www.nbrtaxcalculator.org">nbrtaxcalculator.org</a>
            </div> -->

<!--        <div class="footer_tex">
          <div class="blank_space"></div>
          <p class="news">News <p><a href="#">Aliquam enim enim</a><p> 12 Dec 2014 / <b>by</b> Admin</p>
        </div>
      ...
      <div class="col-lg-4">
        <h3 class="about_bd"><?php echo Yii::t('user', "Contact Us"); ?></h3><hr>
        <!-- <div class="information">
          <div class="info_1">
            <i class="fa fa-home"></i>
            <p>Dk Tower, 94 biruttom road, Dhaka</p>
          </div>
          <div class="info_1">
          ...
          <div class="info_1">
            ...
            <p>info@bdtax.com.bd</p>
          </div>
        </div> -->

        <div class="clearfix"></div>

        <form id="footer-form" class="appnitro"  role="form" method="post" action="<?php echo Yii::app()->baseUrl ?>/index.php/site/compactContact">
          <div class="form-group has-feedback">
            <label for="name2" class="sr-only"><?php echo Yii::t('user', "Name"); ?></label>
            <input type="text" required  name="CompactContactForm[name]"  placeholder="<?php echo Yii::t('user', "Name"); ?>" id="name2" class="form-control">
          </div>
          <div class="form-group has-feedback">
            <label for="email2" class="sr-only"><?php echo Yii::t('user', "Email address"); ?></label>
            <input type="email" required  name="CompactContactForm[email]"  placeholder="<?php echo Yii::t('user', "Email"); ?>" id="email2" class="form-control">
          </div>
          <div class="form-group has-feedback">
            <label for="message2" class="sr-only"><?php echo Yii::t('user', "Message"); ?></label>
            <textarea required  name="CompactContactForm[body]"  placeholder="<?php echo Yii::t('user', "Message"); ?>" id="message2" rows="5" class="form-control"></textarea>
          </div>
          <input type="submit" class="btn btn-default" value="<?php echo Yii::t('user', "SEND MESSAGE"); ?>">
        </form>
...
<link href="<?php echo Yii::app()->request->baseUrl; ?>/css/custom-style.css?v=<?=$this->v?>" rel="stylesheet" type="text/css" />
<style type="text/css">
