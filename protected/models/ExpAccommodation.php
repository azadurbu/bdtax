...
/**
 * This is the model class for table "exp_accommodation".
 *
 * The followings are the available columns in table 'exp_accommodation':
 * @property integer $Id
 ...
 */
class ExpAccommodation extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpAccommodation the static model class
	 */
