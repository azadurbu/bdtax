                                ...
                                <table class="table table-bordred table-striped">
                                    ...
                                    <tbody id="mytable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?php echo @$model->EmployersContributionProvidentFund_1 ?>" type="text" autocomplete="off" onkeyup="onGovtRuleTaxCal(this)" class="form-control" id="IncomeSalaries_EmployersContributionProvidentFund_1" name="IncomeSalaries[EmployersContributionProvidentFund_1]">
                                            </td>
                                            <td>
