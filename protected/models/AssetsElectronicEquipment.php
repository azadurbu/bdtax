...
/**
 * This is the model class for table "assets_electronic_equipment".
 *
 * The followings are the available columns in table 'assets_electronic_equipment':
 * @property integer $Id
 ...
 */
class AssetsElectronicEquipment extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AssetsElectronicEquipment the static model class
	 */
	...
	{
		return 'assets_electronic_equipment';
	}
