  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" onclick="save_IncomeBusinessOrProfession_fraction('IncomeBusinessOrProfessionId',  'IncIncomeBusinessOrProfession', 'IncomeBusinessOrProfession')"><?=Yii::t( 'income', "Store")?></button>
      </div>
      </form>
    </div>
  </div>
