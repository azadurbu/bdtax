...
/**
 * This is the model class for table "exp_festival_other_special".
 *
 * The followings are the available columns in table 'exp_festival_other_special':
 * @property integer $Id
 ...
 */
class ExpFestivalOtherSpecial extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpFestivalOtherSpecial the static model class
	 */
	...
	{
		return 'exp_festival_other_special';
	}
