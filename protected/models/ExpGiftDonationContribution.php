...
/**
 * This is the model class for table "exp_gift_donation_contribution".
 *
 * The followings are the available columns in table 'exp_gift_donation_contribution':
 * @property integer $Id
 ...
 */
class ExpGiftDonationContribution extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpGiftDonationContribution the static model class
	 */
	...
	{
		return 'exp_gift_donation_contribution';
	}
