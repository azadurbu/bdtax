...
class AssetsShareholdingCompanyList extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('AssetsId, NumberOfShares', 'numerical', 'integerOnly'=>true),
			...
			array('Id, AssetsId, CompanyName, NumberOfShares, EachShareCost, CompanyAssetValue, CerateAt, LastUpdateAt', 'safe', 'on'=>'search'),
		);
	}
