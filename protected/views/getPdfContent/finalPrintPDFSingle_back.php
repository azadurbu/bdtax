...
$model = Income::model()->find('CPIId=:data AND EntryYear=:data2', array(':data' => $ctaxYear, ':data2' => $ctaxYear));
...
<div style="float:left;width:77%;">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="3%" style="border-bottom:1px solid;font-weight: normal;"><?php echo htmlentities(strip_tags(@$personal_info_model->TaxesZone))?></td>
                </tr>
                </tbody>
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                ...
                <td width="19%" style="border-bottom: 1px solid;font-weight: normal;">&nbsp;<?php echo strip_tags($ctaxYear);?></td>
                </tr>
               <tr>
...
<div style="float:left;width:22%; padding-left:1%;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      ...
      <?php  
        ...
        <tbody>
          <tr>
            <td width="25%" style="padding: 10px 10px 5px;"><b>10. Taxable Income:</b></td>
        ...
        <?php 
         ...
         if(($IncomeOtherSourceData->SanchaypatraIncome)>0 && ($IncomeOtherSourceData->Others)>0){
           $sourceofIncome[]='Shanchayapatra & Otheres';
         }else{
        ...
        <tbody>
          <tr>
            <td width="27%" style="padding: 10px 10px 5px;">12. Amount of Tax: Tk <?php echo $GrandTotalPayableTax; ?></td>
            ...
            <?php $listChallan = UserChallan::model()->findAll('user_id=:data AND tax_year=:data1', array(':data'=>$cuserid, ':data1'=>$ccpiid));?>
