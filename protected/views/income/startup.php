<div id="home-mid" class="reg-form income-dashbord">
	...
	$haveLastYearData = Income::model()->count('CPIId=:data AND EntryYear=:data2',array(':data'=>Yii::app()->user->CPIId, ':data2'=>$last_tax_year ));
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="pull-right" style="margin-right: 10px;">
				<a href='<?=Yii::app()->baseUrl.'/index.php/income/entry'?>' class='btn btn-success for-clr'><?=Yii::t("assets","Yes")?></a>
			</div>
			<br>
        </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<h3 style="text-align: left;"><?=Yii::t("assets","Are you sure you would like to Copy Data From Last Year?")?></h3>
			...
			<div class="pull-right" style="margin-right: 10px;">
				<a href='<?=Yii::app()->baseUrl.'/index.php/income/copyLastyear'?>' class='btn btn-success for-clr'><?=Yii::t("assets","Yes")?></a>
			</div>
			<br>
        </div>
        <div class="modal-footer">
...
<script type="text/javascript">
	...
	$('#incomeYes').click(function(e) {
		console.log(e);
		e.preventDefault();
		window.location.href = '<?php echo Yii::app()->baseUrl; ?>/index.php/income/entry/';
	});
		
	$('#incomeNo').click(function(e) {
		console.log(e);
		e.preventDefault();
		window.location.href = '<?php echo Yii::app()->baseUrl; ?>/index.php/incomeProperties/create/';
	});
