					...
					<div class="col-md-7">
                    	<div class="row">
                            <div class="col-lg-12" id="language-selector" style="float:right; margin-top:0px;">
                               ...
                               <div class="row facbook-like-top">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div id="navbar" class="navbar-collapse collapse">
                                            ...
                                            <ul class="nav navbar-nav menu">
                                                <li <?php echo ($this->id == 'site' && $this->action->id == 'index') ? ' class="active"':''; ?> ><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php"><?php echo Yii::t('user', "Home"); ?></a></li>

                                                <li <?php echo ($this->id == 'site' && $this->action->id == 'page' && $_GET['view'] == 'about') ? ' class="active"':''; ?> ><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/page?view=about"><?php echo Yii::t('user', "About Us"); ?></a></li>
												...
												<?php if (Yii::app()->user->name == 'Guest') { ?>
                                                    <li><a href="<?=Yii::app()->request->baseUrl?>/index.php/user/registration/registerIndividual"><?php echo Yii::t('user', "Individuals"); ?></a></li>
                                                    <li><a href="<?=Yii::app()->request->baseUrl?>/index.php/user/registration/registercompany"><?php echo Yii::t('user', "Companies"); ?></a></li>

                                                    <!--<li><a href="<?=Yii::app()->request->baseUrl?>/index.php/user/registration"><?php echo Yii::t('user', "Plans"); ?></a></li>-->
                                                <?php } else { ?>
...
-->
                                               ...
                                               <!--  <li><a href="https://bdtax.freshdesk.com/support/home" target="_blank"><?php echo Yii::t('user', "Support"); ?></a></li> -->
												...
												<li <?php echo ($this->id == 'site' && $this->action->id == 'page' && $_GET['view'] == 'news') ? ' class="active"':''; ?> ><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/page?view=news"><?php echo Yii::t('user', "News"); ?></a></li>
												<li ><a target="_blank" href="https://training.bdtax.com.bd/"><?php echo Yii::t('user', "Training"); ?></a></li>

                                                <li <?php echo ($this->id == 'site' && $this->action->id == 'contact') ? ' class="active"':''; ?>><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/contact"><?php echo Yii::t('user', "Contact Us"); ?></a></li>
                                            </ul>
                                        </div><!--/.nav-collapse -->
                                    </div><!--/.container-fluid -->
                                </nav>
...
<script type="text/javascript">
	...
	$('#startForFree').click(function(e) {
// console.log(e);
e.preventDefault();
window.location.href = baseUrl+'/index.php/user/registration/';
});
</script>
