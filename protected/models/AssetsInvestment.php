...
class AssetsInvestment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('InvestmentType', 'length', 'max'=>40),
			array('Description, CerateAt, LastUpdateAt', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('Id, AssetsId, InvestmentType, Description, Cost, CerateAt, LastUpdateAt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('InvestmentType',$this->InvestmentType,true);
