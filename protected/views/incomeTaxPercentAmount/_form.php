<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'income-tax-percent-amount-form',
...
<div class="form-group"><?php echo CHtml::activeLabelEx($model,'Amount', array('class'=>'col-sm-2')); ?>
<div class="col-sm-3 form-inline"><?php echo $form->textField($model,'Amount', array('class' => 'form-control')); ?>
