...
/**
 * This is the model class for table "assets_business_capital".
 *
 * The followings are the available columns in table 'assets_business_capital':
 * @property integer $Id
 ...
 */
class AssetsBusinessCapital extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AssetsBusinessCapital the static model class
	 */
	...
	{
		return 'assets_business_capital';
	}
