...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
    ...
    <td  style="border: 1px solid #000;" valign="top">
        <table cellspacing="0" cellpadding="0" style="margin-left:5px">
                    <tr>
                        ...
                        <td width="30" style="border: 1px solid #000; padding:5px;" valign="top"></td> 
                    </tr>
               </table>
    </td>
    ...
    <td style="border-right:1px solid #000; padding:5px;" valign="top">
        <table cellspacing="0" cellpadding="0" width="130" border="0">
          <tr>
            ...
            <td width="22" style="border: 1px solid #000; padding:5px;" valign="top"><?php echo (@$personal_info_model->Gender=='Male')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
            <td width="15" style="padding:5px;" valign="top" >&nbsp;</td>
            <td width="25" style="border: 1px solid #000; padding:5px;" valign="top">F</td>
            <td width="23" style="border: 1px solid #000; padding:5px;" valign="top"><?php echo (@$personal_info_model->Gender=='Female')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
          </tr>
        </table>
    </td>
  </tr>
  <tr>
    ...
    <td style="border: 1px solid #000; padding:5px;"  valign="top" colspan="2">Twelve-digit TIN <h5 style="font-weight: bold"><?php echo htmlentities(strip_tags(@$personal_info_model->ETIN))?></h5></td>
    <td style="border: 1px solid #000; padding:5px;" align="center" valign="top">
      06
        <p>&nbsp;</p>
    </td>
            ...
            <td style="border-right: 1px solid #000;" width="220">
               <table cellspacing="0" cellpadding="0" style="margin-left:10px;">
                    <tr>
                        ...
                        <td width="30" style="border: 1px solid #000; padding:5px;" valign="top"><?php echo (@$personal_info_model->ResidentialStatus=='Y')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td> 
                    </tr>
               </table>
            </td>
            <td width="180">
               ...
               <table cellspacing="0" cellpadding="0" style="margin-left:10px;">
                    <tr>
                        ...
                        <td width="30" style="border: 1px solid #000; padding:5px;" valign="top"><?php echo (@$personal_info_model->ResidentialStatus=='N')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td> </td> 
                    </tr>
                  </table>
   ...
   <tr>
           ...
           <tr>
             ...
             <td width="21%" style="">
              ...
              <table cellspacing="0" cellpadding="0" width="100%" border="1" style=" margin-left:15px;">
                  <tr>
                    <td style="border: 1px solid #000; padding:5px; width:30px; height:25px;"><?php echo (@$personal_info_model->FreedomFighter=='Y')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
                  </tr>
                </table>
     ...
     <table cellspacing="0" cellpadding="0" width="196" border="0" style="margin:0 5px;">
       <tr>
         ...
         <td width="30" style="border: 1px solid #000; padding:5px;" valign="top"><?php echo (@$personal_info_model->Disability=='YES')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
       </tr>
      </table>
     </td>
   </tr>
       ...
       <tr>
         ...
         <td width="21%">
           ...
           ?>
            <table cellspacing="0" cellpadding="0" width="100%" border="1" style=" margin-left:15px;">
                  <tr>
                    <td style="border: 1px solid #000; padding:5px; width:30px; height:25px;"><?php echo (@$age>=65)?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
                  </tr>
                </table>
         </td>
       </tr>
...
with disability</td>
         <td width="8%" style="border: 1px solid #000; padding:5px;" valign="top"><?php echo (@$personal_info_model->AnyDisabledChild=='Y')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
       </tr>
      </table>
     </td>
   </tr>
   ...
   <tr>
    ...
    <td style="border: 1px solid #000; padding:5px;" valign="top" colspan="2">Spouse TIN (if any)<h5 style="font-weight: bold"><?php echo htmlentities(strip_tags(@$personal_info_model->SpouseETIN)) ?></h5></td>
  </tr>
   <tr>
   ...
   <tr>
    ...
    <td style="border: 1px solid #000; height:100px; padding:5px;" colspan="2" valign="top"><p>Permanent Address</p>
      <br>
      <h5 style="font-weight: bold">
        <?php echo htmlentities(strip_tags(@$personal_info_model->PermanentAddress)); ?>
      </h5>
    </td>
  </tr>
   <tr>
...
<?php 
  $eTin=str_split(htmlentities(strip_tags(@$personal_info_model->ETIN)));
...
<tr>
  <td width="600" style="font-size:16px; font-weight:normal"><p>Particulars of Total Income</p></td>
    <td width="200" style="text-align:center;font-size:16px; font-weight:normal"><p>Amount$</p></td>
</tr>
</table>
<table cellspacing="0" cellpadding="0" width="100%" border="1">
  <tbody>
    <tr>
      <td width="5%" align="center" style="padding:7px;" valign="top">
        <p>24</p>
      </td>
      <td width="62%" style="padding:7px;" valign="top">
        <p>Salaries (annex Schedule 24A)</p>
      </td>
      <td width="9%" align="center" style="padding:7px;" valign="top">
        <p>S.21</p>
      </td>
      <td width="23%" style="padding:7px;" valign="top">
    ...
    <tr>
      ...
      <td width="23%" style="padding:7px;" valign="top">
        <?php echo @$this->totalOutputMain('InterestOnSecurities'); ?>
      </td>
    </tr>
    <tr>
      <td width="5%" align="center" style="padding:7px;" valign="top">
    ...
    <tr>
      ...
      <td width="9%" style="padding:7px;" valign="top">&nbsp;</td>
      <td width="23%" style="padding:7px;" valign="top"><?php echo @$this->totalOutputMain('IncomeShareProfit'); ?></td>
    </tr>
    <tr>
      <td width="5%" align="center" style="padding:7px;" valign="top">
        <p>32</p>
      ...
      <td width="23%" style="padding:7px;" valign="top"><?php echo @$this->totalOutputMain('IncomeSpouseOrChild'); ?></td>
    </tr>
    <tr>
      <td width="5%" align="center" style="padding:7px;" valign="top">
        <p>33</p>
    ...
    <tr>
      ...
      <td width="23%" style="padding:7px;" valign="top">
        <?php 
          $totalIncome = $this->totalIncome(Yii::app()->user->CPIId) + @$this->totalOutputMain('ForeignIncome'); 
          echo $totalIncome;
        ?>
      </td>
    </tr>
...
<table cellspacing="0" cellpadding="0" width="100%" border="1">
  <tbody>
    <tr>
      ...
      <td width="71%" style="padding:7px;" valign="top">
        <p>Gross tax before tax rebate</p>
      </td>
      <td width="23%" style="padding:7px;" valign="top">
        <?php
          $TaxLeviableOnTotalIncome = $this->TaxLeviableOnTotalIncome(Yii::app()->user->CPIId);
    ...
    <tr>
      ...
      <td width="23%" style="padding:7px;" valign="top">
        <?php echo $this->minimumTaxValue(Yii::app()->user->CPIId); ?>
      </td>
    </tr>
    <tr>
      <td width="5%" align="center" style="padding:7px;" valign="top">
    ...
    <tr>
      ...
      <td width="23%" style="padding:7px;" valign="top">
        <?php
          $total16c = ($GrandTotalPayableTax - (@$tds + @$this->totalOutputInNumber($income_model, 'IncomeTaxInAdvance') + @$income_model->AdjustmentTaxRefund));
    ...
    <tr>
      ...
      <td width="23%" style="padding:7px;" valign="top">
        <?php
          echo ($GrandTotalPayableTax - $total16);
        ?>
      </td>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
  <tbody>
    <tr>
      <td width="2%" style="border: 1px solid #000; padding:7px;" align="center" valign="top">
        <p>49</p>     </td>
      <td colspan="4" style="border: 1px solid #000; padding:7px;" valign="top">
              ...
              <td style="border-right:1px solid #000; padding:5px;" valign="top">
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                      ...
                      <td style="border:1px solid #000; width:30px; height:25px;"><?php echo (@$personal_info_model->Status=='Married' && @$personal_info_model->AnyDisabledChild=='Y')?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
                    </tr>
                </table>
              </td>
              <td style="padding:5px;" valign="top">
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                      ...
                      <td style="border:1px solid #000; width:30px; height:25px;"><?php echo (@$personal_info_model->Status=='Single' || (@$personal_info_model->Status=='Married' && @$personal_info_model->AnyDisabledChild=='N'))?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
                    </tr>
                </table>
              </td>
            </tr>
      ...
      <td colspan="4" valign="top"  style="border: 1px solid #000; padding:0 7px;"><table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
              ...
              <td style="border-right:1px solid #000; padding:5px;" valign="top"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                  <tr>
                    <td width="40" valign="top">Yes</td>
                    <td style="border:1px solid #000; width:30px; height:25px;"><?php echo (!empty($shareholdingCompanyList) || !empty($nonAgriculturePropertyList) || !empty($AgriculturePropertyList))?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;'; ?></td>
                  </tr>
              </table></td>
    ...
    <tr>
      <td width="2%" style="border: 1px solid #000; padding:7px;" align="center" valign="top">
        <p>52</p>     </td>
      <td width="29%" style="border: 1px solid #000; padding:7px;" valign="top">
    ...
    <td width="69%" colspan="3" valign="top" style="border: 1px solid #000; padding:5px;">
      <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    ...
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top"><?php echo (is_null($totalIncomeSalaries->SumTaxableIncome))?'&nbsp;':'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">';  ?></td>
                    <td width="10%" style="padding:5px;" valign="top">&nbsp;</td>
                    ...
                    echo (sizeof($income_house_model)>0)?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;';  ?></td>
                    <td width="10%" style="padding:5px;" valign="top">&nbsp;</td>
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top">24C</td>
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top"><?php 
                    echo ($income_model['IncomeBusinessOrProfessionConfirm']==True)?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;';  ?></td>
                    <td width="10%" style="padding:5px;" valign="top">&nbsp;</td>
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top">24D</td>
                    <td width="10%" style="border: 1px solid #000; padding:5px;" valign="top"><?php 
                    echo ($income_model['IncomeTaxRebateConfirm']==True)?'<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">':'&nbsp;';  ?></td>
                     <td width="5" style="padding:5px;" valign="top">&nbsp;</td>
                  </tr>
        </table>          
                </td>
...
<td colspan="3" style="border: 1px solid #000; padding:7px 10px 7px 7px;"  valign="top">
              ...
              <table cellspacing="0" cellpadding="0" width="100%"  style="margin-left:18px;">
                  <tr>
                    <td style="border: 1px solid #000; padding:7px;" align="center" valign="top" width="110">IT-10B2016</td>
                    <td style="border: 1px solid #000; padding:7px;" align="center" valign="top"  width="30"><?php echo '<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">';?></td>
                    <td  width="68">&nbsp;</td>
                    <td style="border: 1px solid #000; padding:7px;" align="center" valign="top"  width="110">IT-10BB2016</td>
                    <td style="border: 1px solid #000; padding:7px; " align="center" valign="top"  width="30"><?php echo '<img border="0" width="20px" src="'.Yii::app()->baseUrl .'/img/tick.png">';?></td>
                  </tr>
                </table>          </td>
    </tr>
...
<table cellspacing="0" cellpadding="0" width="100%" border="1">
  <tbody>
    <tr>
      <td rowspan="3" width="5%" style="padding:7px;" valign="top">
        <p>55</p>
      </td>
      <td colspan="2" width="94%" style="padding:7px;" valign="top">
  ...
  <tbody>
      ...
      <td width="23%" style="border:1px solid #000; padding:5px 0 5px 5px; " valign="top">
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    ...
                    <td width="30" style="border:1px solid #000; height:25px; text-align:center" valign="top">&nbsp;</td>
                  </tr>
                </table>
    ...
    <tr>
      <td width="50%"  style="border:1px solid #000; padding:10px;" valign="top">
        ...
        <p><?php echo htmlentities(strip_tags(@$personal_info_model->ETIN)); ?></p>
      </td>
    ...
    <tr>
      <td width="50%" style="border:1px solid #000; padding:10px;" valign="top">
        ...
        <p>Tk</p>
              <p><?php echo ($totalAssets - $totalLiabilities);?></p>
      </td>
      <td colspan="2" width="49%" style="border:1px solid #000; padding:10px;" valign="top">
  ...
  <tbody>
    <tr>
      ...
      <td width="48%" style="padding:10px;border:1px solid #000;">
        <p>TIN</p>
        <h5><?php echo htmlentities(strip_tags(@$personal_info_model->ETIN))?></h5>
      </td>
    </tr>
  </tbody>
</table>
...
<h6 style="text-align:center; font-weight:normal;">Particulars of income from house property</h6>
<h6 style="text-align:center; font-weight:normal;"><em>Annex this Schedule to the return of income if you have income from house property</em></h6>
<p>&nbsp;</p>
        ...
        <p>Assessment Year</p>
            <table cellspacing="0" cellpadding="0" width="320" border="0">
                  <tr>
                    ...
                    <td align="center" width="14%" style="padding:10px; border:1px solid #000; padding:5x;" valign="top">0</td>
                    <td align="center" width="14%" style="padding:10px; border:1px solid #000;"><?php echo $tax_year_stripe[2];?></td>
                    <td align="center" width="14%" style="padding:10px; border:1px solid #000;"><?php echo $tax_year_stripe[3];?></td>
                    <td align="center" width="14%">-</td>
                    <td align="center" width="14%" style="padding:10px; border:1px solid #000;"><?php echo $tax_year_stripe[7];?></td>
...
<p>&nbsp;</p>
<b style="font-weight:normal;">For each house property</b>
<?php foreach ($income_house_model as $income_house_model_key => $income_house_model_value) { ?>
<table cellspacing="0" cellpadding="0" width="100%" border="1">
  <tbody>
    <tr>
...
<table width="100%" border="1">
	<tbody>
		<tr>
			...
			<td width="312" style="padding:5px;" valign="top">
				<p>Signature &amp; Date</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
			</td>
...
<h6 style="text-align: center; font-weight:normal;">Particulars of tax credit/rebate</h6>
<h6 style="text-align: center; font-weight:normal;">To be annexed to return by an assessee claiming investment tax credit</h6>
<h6 style="text-align: center; font-weight:normal;">(Attach the proof of claimed investment, contribution, etc.)</h6>
<p>&nbsp;</p>
<table cellspacing="0" cellpadding="0" width="618">
  <tbody>
    <tr>
...
<table cellspacing="0" cellpadding="0" width="646">
  <tbody>
    ...
    <?php 
      $fixedCore=15000000; 
      $eligibleRebateAmount = min($TotalIncomeTaxRebate, $ActualRebateAmount, $fixedCore);
    ...
    <tr>
      ...
      <td width="425" style="padding:5px; border:1px solid #000;" valign="top">
        <p>........ &nbsp;% of the total income [excluding any income for which a tax exemption or a reduced rate is applicable under sub-section (4) of section 44 or any income from any source or sources mentioned in clause (a) of sub-section (2) of section 82C.]</p>
      </td>
      <td width="132" style="padding:5px; border:1px solid #000;" valign="top">
        <p>
          <?php
  ...
  <tbody>
    <tr>
      ...
      <td width="45%" style="padding:10px; border:1px solid #000;">
        ...
        <table cellspacing="0" cellpadding="0" width="320" border="0">
                    <tr>
                      <td align="center" width="10%" style="padding:10px; border:1px solid #000;"><?php echo $present_date_stripe[0];?></td>
                      <td align="center" width="10%" style="padding:10px; border:1px solid #000;"><?php echo $present_date_stripe[1];?></td>
                      <td align="center" width="1%">&nbsp;</td>
                      <td align="center" width="10%" style="padding:10px; border:1px solid #000; border-right:none;"><?php echo $present_date_stripe[3];?></td>
                      <td align="center" width="10%" style="padding:10px; border:1px solid #000;"><?php echo $present_date_stripe[4];?></td>
                      <td align="center" width="1%">&nbsp;</td>
...
<table cellspacing="0" cellpadding="0" width="101%" border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="4" width="72%" style="padding:5px;" valign="top">
        <p>Gold, diamond, gems and other items(mention quantity)</p>
      </td>
      <td width="21%" style="padding:5px;" valign="top">
        <p>
    ...
    <tr>
      ...
      <td width="21%" style="padding:5px;" valign="top">
        <p><?php echo $accretionWealth_14; ?></p>
      </td>
    </tr>
    <tr>
      <td rowspan="4" width="5%" style="padding:5px;" valign="top">
    ...
    <tr>
      ...
      <td width="21%" style="padding:5px;" valign="top">
        <p><?php echo $totalIncome = $this->totalIncome(Yii::app()->user->CPIId); ?></p>
      </td>
    </tr>
    <tr>
      <td width="6%" style="padding:5px;" valign="top">
      ...
      <td width="21%" style="padding:5px;" valign="top">
        <p><?php echo $totalExemptedValue; ?></p>
      </td>
    </tr>
    <tr>
      <td width="6%" style="padding:5px;" valign="top">
  ...
  <tbody>
    <tr>
      ...
      <td width="15%" style="padding:5px;"  valign="top">
        <p>Value at the start of income year৳</p>
      </td>
      <td width="17%" style="padding:5px;"  valign="top">
        <p>increased/ decreased during the income year ৳</p>
      </td>
      <td width="17%" style="padding:5px;"  valign="top">
        <p>Value at the last date of income year ৳</p>
      </td>
    </tr>
      <?php
  ...
  <tbody>
    <tr>
      ...
      <td width="45%" style="padding:10px; border:1px solid #000;">
        ...
        <table cellspacing="0" cellpadding="0" width="320" border="0">
                    <tr>
                      <td align="center" width="10%" style="padding:5px; border:1px solid #000;"><?php echo $present_date_stripe[0];?></td>
                      <td align="center" width="10%" style="padding:5px; border:1px solid #000;"><?php echo $present_date_stripe[1];?></td>
                      <td align="center" width="1%">&nbsp;</td>
                      <td align="center" width="10%" style="padding:5px; border:1px solid #000; border-right:none;"><?php echo $present_date_stripe[3];?></td>
                      <td align="center" width="10%" style="padding:5px; border:1px solid #000;"><?php echo $present_date_stripe[4];?></td>
                      <td align="center" width="1%">&nbsp;</td>
  ...
  <tbody>
    <tr>
      ...
      <td colspan="2" width="93%" style="padding:0 5px 7px 5px;" valign="top">
        <p style="font-weight:bold;"><strong>Verification</strong></p>
        <p style="font-weight:normal;">I solemnly declare that to the best of my knowledge and belief the information given in this statement iscorrect and complete.</p>
      </td>
    </tr>
    <tr>
