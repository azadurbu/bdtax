<div class="view">
		...
		<b><?php echo CHtml::encode($data->getAttributeLabel('IncomeBusinessOrProfessionId')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->IncomeBusinessOrProfessionId),array('view','id'=>$data->IncomeBusinessOrProfessionId)); ?>
	<br />
