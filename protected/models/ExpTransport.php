...
/**
 * This is the model class for table "exp_transport".
 *
 * The followings are the available columns in table 'exp_transport':
 * @property integer $Id
 ...
 */
class ExpTransport extends CActiveRecord
{
	/**
