...
/**
 * This is the model class for table "exp_other_transport".
 *
 * The followings are the available columns in table 'exp_other_transport':
 * @property integer $Id
 ...
 */
class ExpOtherTransport extends CActiveRecord
{
	/**
