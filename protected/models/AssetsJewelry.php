...
/**
 * This is the model class for table "assets_jewelry".
 *
 * The followings are the available columns in table 'assets_jewelry':
 * @property integer $Id
 ...
 */
class AssetsJewelry extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AssetsJewelry the static model class
	 */
