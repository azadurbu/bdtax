...
/**
 * This is the model class for table "lia_unsecured_loans".
 *
 * The followings are the available columns in table 'lia_unsecured_loans':
 * @property integer $Id
 ...
 */
class LiaUnsecuredLoans extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LiaUnsecuredLoans the static model class
	 */
