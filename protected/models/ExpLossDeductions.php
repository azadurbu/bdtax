...
/**
 * This is the model class for table "exp_loss_deductions".
 *
 * The followings are the available columns in table 'exp_loss_deductions':
 * @property integer $Id
 ...
 */
class ExpLossDeductions extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpLossDeductions the static model class
	 */
