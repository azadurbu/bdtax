...
/**
 * This is the model class for table "exp_personal_fooding".
 *
 * The followings are the available columns in table 'exp_personal_fooding':
 * @property integer $Id
 ...
 */
class ExpPersonalFooding extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpPersonalFooding the static model class
	 */
