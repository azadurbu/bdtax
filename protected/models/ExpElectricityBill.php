...
/**
 * This is the model class for table "exp_electricity_bill".
 *
 * The followings are the available columns in table 'exp_electricity_bill':
 * @property integer $Id
 ...
 */
class ExpElectricityBill extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpElectricityBill the static model class
	 */
