 ...
 *
 * This is the main YiiBootstrap component which you should attach to your Yii CWebApplication instance.
 *
...
class Bootstrap extends CApplicationComponent
{
	...
	/**
	 * @var boolean Whether to register YiiBootstrap custom CSS overrides
	 ...
	 * If set to true, all YiiBootstrap assets will be republished on each request.
	 * Passing null to this option restores the default handling of CAssetManager of YiiBootstrap assets.
	 *
	 * @since YiiBootstrap 1.0.6
	 */
