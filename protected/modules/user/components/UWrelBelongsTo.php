...
class UWrelBelongsTo {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>Yii::t('user','Relation Belongs To',array(),__CLASS__),
			'fieldType'=>array('INTEGER'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'modelName'=>Yii::t('user','Model Name',array(),__CLASS__),
				'optionName'=>Yii::t('user','Lable field name',array(),__CLASS__),
				'emptyField'=>Yii::t('user','Empty item name',array(),__CLASS__),
