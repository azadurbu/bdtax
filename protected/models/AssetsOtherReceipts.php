...
/**
 * This is the model class for table "assets_other_receipts".
 *
 * The followings are the available columns in table 'assets_other_receipts':
 * @property integer $Id
 ...
 */
class AssetsOtherReceipts extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AssetsOtherReceipts the static model class
	 */
