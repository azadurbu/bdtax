...
/**
 * This is the model class for table "exp_telephone_bill".
 *
 * The followings are the available columns in table 'exp_telephone_bill':
 * @property integer $Id
 ...
 */
class ExpTelephoneBill extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExpTelephoneBill the static model class
	 */
