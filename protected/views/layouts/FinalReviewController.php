	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions' => array('index', 'finalReview', 'finalPrint', 'viewPdf', 'finalPrintPDF', 'print', 'taxPrint', 'taxPdf', 'googleRedirect','func82bb','viewSinglePdfDetails','viewSinglePdf'),
				'users' => array('@'),
