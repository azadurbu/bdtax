...
class UHtml extends CHtml
{
    public static function activeTimeField($model,$attribute,$htmlOptions=array())
    {
                ...
                $monthOptions = array(
					'0' => ' - ',
					'1'=> Yii::t('user','January'),
					'2'=> Yii::t('user','February'),
					'3'=> Yii::t('user','March'),
					'4'=> Yii::t('user','April'),
					'5'=> Yii::t('user','May'),
					'6'=> Yii::t('user','June'),
					'7'=> Yii::t('user','July'),
					'8'=> Yii::t('user','August'),
					'9'=> Yii::t('user','September'),
					'10'=> Yii::t('user','October'),
					'11'=> Yii::t('user','November'),
					'12'=> Yii::t('user','December'),
                );
	...
	public static function activeDateField($model,$attribute,$htmlOptions=array())
    {
                ...
                $monthOptions = array(
					'00' => ' - ',
					'01'=> Yii::t('user','January'),
					'02'=> Yii::t('user','February'),
					'03'=> Yii::t('user','March'),
					'04'=> Yii::t('user','April'),
					'05'=> Yii::t('user','May'),
					'06'=> Yii::t('user','June'),
					'07'=> Yii::t('user','July'),
					'08'=> Yii::t('user','August'),
					'09'=> Yii::t('user','September'),
					'10'=> Yii::t('user','October'),
					'11'=> Yii::t('user','November'),
					'12'=> Yii::t('user','December'),
                );
